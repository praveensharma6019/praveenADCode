namespace Sitecore.Feature.Search.Controllers
{
    ...
    public class SearchController : Controller
    {
        ...
        public ActionResult GlobalSearchAustralia()
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult SearchResultsHeaderAsutralia(string query, int? page, string facets)
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult SearchResultsAustralia(string query)
        {
            var searchResults = this.GetSearchResults(query, null, null);
            return this.View(searchResults.Results);
        }

        public ActionResult PagedSearchResultsAsutralia(string query, int? page, string facets)
        {
            var results = this.GetSearchResults(query, page, facets);
            return this.View(results);
        }

        public ActionResult SearchFacetsAustralia(string query, int? page, string facets)
        {
            var searchResults = this.GetSearchResults(query, page, facets);
            return this.View(searchResults);
        }
        ...
        #region Realty
        public ActionResult GlobalSearchRealty()
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult SearchResultsHeaderRealty(string query, int? page, string facets)
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult SearchResultsRealty(string query)
        {
            var searchResults = this.GetSearchResults(query, null, null);
            return this.View(searchResults.Results);
        }

        public ActionResult PagedSearchResultsRealty(string query, int? page, string facets)
        {
            var results = this.GetSearchResults(query, page, facets);
            return this.View(results);
        }

        public ActionResult SearchFacetsRealty(string query, int? page, string facets)
        {
            var searchResults = this.GetSearchResults(query, page, facets);
            return this.View(searchResults);
        }
        ...
        public ActionResult ClubAhmedabadGlobalSearch()
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult ClubAhmedabadSearchResultsHeader(string query, int? page, string facets)
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult ClubAhmedabadPagedSearchResults(string query, int? page, string facets)
        {
            var results = this.GetSearchResults(query, page, facets);
            return this.View(results);
        }

        public ActionResult ClubAhmedabadSearchFacets(string query, int? page, string facets)
        {
            var searchResults = this.GetSearchResults(query, page, facets);
            return this.View(searchResults);
        }
        ...
        #region AdaniGas
        public ActionResult GlobalSearchAdaniGas()
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult SearchResultsHeaderAdaniGas(string query, int? page, string facets)
        {
            var searchContext = this.SearchContextRepository.Get();
            if (searchContext == null)
            {
        ...
        public ActionResult SearchResultsAdaniGas(string query)
        {
            var searchResults = this.GetSearchResults(query, null, null);
            return this.View(searchResults.Results);
        }

        public ActionResult PagedSearchResultsAdaniGas(string query, int? page, string facets)
        {
            var results = this.GetSearchResults(query, page, facets);
            return this.View(results);
        }

        public ActionResult SearchFacetsAdaniGas(string query, int? page, string facets)
        {
            var searchResults = this.GetSearchResults(query, page, facets);
            return this.View(searchResults);
        }
