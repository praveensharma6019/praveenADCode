...
namespace Adani.SuperApp.Airport.Feature.Navigation.Platform.Services
{
    public class HeaderDataList : IHeaderDataList
    {
        ...
        public HeaderData GetHeaderData(Item datasource)
        {
            ...
            List<TopNavigation> topNavigationLeftlist = new List<TopNavigation>();
            ...
            try
            {
                ...
                if (listItems != null && listItems.Count() > 0)
                {
                    foreach (Sitecore.Data.Items.Item item in listItems)
                    {
                        ...
                        if (branchID == Constant.TopNavLeftIcons)
                        {
                            ...
                            if (ChildlinkItems != null && ChildlinkItems.Count() > 0)
                            {
                                ...
                                foreach (Sitecore.Data.Items.Item childrenlink in ChildlinkItems)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        topNav.IsAgePopup = _helper.GetCheckboxOption(childrenlink.Fields[Constant.Link_isAgePopup]);
                                        topNav.LinkTarget = childrenlink.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(childrenlink.Fields[Constant.Link_Url]) : String.Empty;
                                        if (childrenlink.Children?.Count > 0)
                                        {
                                            ...
                                            if (ChildlinkItemsL2 != null && ChildlinkItemsL2.Count() > 0)
                                            {
                                                ...
                                                foreach (Sitecore.Data.Items.Item ChildlinkItemsL3 in ChildlinkItemsL2)
                                                {
                                                    ...
                                                    topNavchild.IsAgePopup = _helper.GetCheckboxOption(ChildlinkItemsL3.Fields[Constant.Link_isAgePopup]);
                                                    topNavchild.LinkTarget = ChildlinkItemsL3.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(ChildlinkItemsL3.Fields[Constant.Link_Url]) : String.Empty;
                                        ...
                                        topNavigationLeftlist.Add(topNav);
                                    }
                                    catch (Exception ex)
                                    {
                                ...
                                headerDetails.TopNavigationLeftIcons = topNavigationLeftlist;

                            }
                        }
                        else if (branchID == Constant.TopNavigationID)
                        {
                            ...
                            if (ChildbranchItems != null && ChildbranchItems.Count() > 0)
                            {
                                ...
                                foreach (Sitecore.Data.Items.Item children in ChildbranchItems)
                                {
                                    ...
                                    if (childbranchname == Constant.AdaniAirportID)
                                    {
                                        ...
                                        info.IsAgePopup = _helper.GetCheckboxOption(children.Fields[Constant.Link_isAgePopup]);
                                        info.LinkTarget = children.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(children.Fields[Constant.Link_Url]) : String.Empty;
                                        ...
                                        if (ChildlinkItems != null && ChildlinkItems.Count() > 0)
                                        {
                                            ...
                                            foreach (Item Informationitem in ChildlinkItems)
                                            {
                                                ...
                                                infochild.IsAgePopup = _helper.GetCheckboxOption(Informationitem.Fields[Constant.Link_isAgePopup]);
                                                infochild.LinkTarget = Informationitem.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(Informationitem.Fields[Constant.Link_Url]) : String.Empty;
                                                if (Informationitem.Children?.Count > 0)
                                                {
                                                    ...
                                                    if (ChildlinkItemsL3 != null && ChildlinkItemsL3.Count() > 0)
                                                    {
                                                        ...
                                                        foreach (Sitecore.Data.Items.Item InformationitemL3 in ChildlinkItemsL3)
                                                        {
                                                            ...
                                                            topNavchild1.IsAgePopup = _helper.GetCheckboxOption(InformationitemL3.Fields[Constant.Link_isAgePopup]);
                                                            topNavchild1.LinkTarget = InformationitemL3.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(InformationitemL3.Fields[Constant.Link_Url]) : String.Empty;
                                                            topNavchild1.tagName = InformationitemL3.Fields[Constant.TagName].Value;
                                    ...
                                    else if (childbranchname == Constant.OtherID)
                                    {
                                        ...
                                        others.IsAgePopup = _helper.GetCheckboxOption(children.Fields[Constant.Link_isAgePopup]);
                                        others.LinkTarget = children.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(children.Fields[Constant.Link_Url]) : String.Empty;
                                        ...
                                        if (ChildlinkItems != null && ChildlinkItems.Count() > 0)
                                        {
                                            ...
                                            foreach (Item Childlinkitem1 in ChildlinkItems)
                                            {
                                                ...
                                                infochild.IsAgePopup = _helper.GetCheckboxOption(Childlinkitem1.Fields[Constant.Link_isAgePopup]);
                                                infochild.LinkTarget = Childlinkitem1.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(Childlinkitem1.Fields[Constant.Link_Url]) : String.Empty;
                                                toNavChildList.Add(infochild);
                                    ...
                                    else if (childbranchname == Constant.AdaniBusinessesID)
                                    {
                                        ...
                                        adaniBusinesses.IsAgePopup = _helper.GetCheckboxOption(children.Fields[Constant.Link_isAgePopup]);
                                        adaniBusinesses.LinkTarget = children.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(children.Fields[Constant.Link_Url]) : String.Empty;
                                        IEnumerable <Item> ChildlinkItems = children.Children.Where(x => x.TemplateID == Templates.AirportNavigation.LinkTemplateID && _helper.GetCheckboxOption(x.Fields["IsActive"]) == true).ToList();
                                        if (ChildlinkItems != null && ChildlinkItems.Count() > 0)
                                        {
                                            List<ChildNavigation> toNavChildList = new List<ChildNavigation>();
                                    ...
                                    if (childrenlink.Children?.Count > 0)
                                    {
                                        ...
                                        if (ChildlinkItemsL2 != null && ChildlinkItemsL2.Count() > 0)
                                        {
                                            ...
                                            foreach (Sitecore.Data.Items.Item ChildlinkitemL2 in ChildlinkItemsL2)
                                            {
                                                ...
                                                topNavchild.IsAgePopup = _helper.GetCheckboxOption(ChildlinkitemL2.Fields[Constant.Link_isAgePopup]);
                                                topNavchild.LinkTarget = ChildlinkitemL2.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(ChildlinkitemL2.Fields[Constant.Link_Url]) : String.Empty;
                                                if (ChildlinkitemL2.Children?.Count > 0)
                                                {
                                                    ...
                                                    if (ChildlinkItemsL3 != null && ChildlinkItemsL3.Count() > 0)
                                                    {
                                                        ...
                                                        foreach (Sitecore.Data.Items.Item ChildlinkitemL3 in ChildlinkItemsL3)
                                                        {
                                                            ...
                                                            topNavchild1.IsAgePopup = _helper.GetCheckboxOption(ChildlinkitemL3.Fields[Constant.Link_isAgePopup]);
                                                            topNavchild1.LinkTarget = ChildlinkitemL3.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(ChildlinkitemL3.Fields[Constant.Link_Url]) : String.Empty;
                                                            toNavChildList1.Add(topNavchild1);
                                                        }
                                    ...
                                    if (childrenlink.Children?.Count > 0)
                                    {
                                        ...
                                        if (ChildlinkItemsL2 != null && ChildlinkItemsL2.Count() > 0)
                                        {
                                            ...
                                            foreach (Sitecore.Data.Items.Item childrenitemL2 in ChildlinkItemsL2)
                                            {
                                                ...
                                                topNavchild.LinkTarget = childrenitemL2.Fields[Constant.Link_Url] != null ? _helper.LinkUrlTarget(childrenitemL2.Fields[Constant.Link_Url]) : String.Empty;
                                                toNavChildList.Add(topNavchild);
                        ...
                        if (item.Name == Constant.AirportListID)
                        {
                            ...
                            if (ChildlinkItems != null && ChildlinkItems.Count() > 0)
                            {
                                ...
                                foreach (Sitecore.Data.Items.Item childrenlink in ChildlinkItems)
                                {
                                    ...
                                    topNavchild.airportName= !string.IsNullOrEmpty(childrenlink.Fields[Constant.airportName].Value.ToString()) ? childrenlink.Fields[Constant.airportName].Value.ToString() : ""; ;
                                    toNavChildList.Add(topNavchild);
