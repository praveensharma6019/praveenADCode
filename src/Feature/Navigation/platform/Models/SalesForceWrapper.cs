...
namespace Adani.SuperApp.Realty.Feature.Navigation.Platform.Models
{
    public class SalesForceWrapper
    {
        ...
        public readonly string TokenUrl, SecurityToken, ConsumerKey, ConsumerSecret, Username, IsSandboxUser, SfdcSandboxEndPoint, SfdcProductionEndPoint;
        ...
        public SalesForceWrapper()
        {
            try
            {
                ...
                GetToken();
                Sitecore.Diagnostics.Log.Info("Enquire now - Salesforce lead generation - get Configuration done: " + ConsumerKey + "," + ConsumerSecret + "," + Username + "," + TokenUrl, this);
        ...
        public dynamic GenerateLead(LeadObject1 obj)
        {
            string result;
            try
            {
                ...
                req.Accept = "application/json";
                req.Method = "POST";
                List<LeadObject1> t = new List<LeadObject1>();
                t.Add(obj);
    ...
    public class LeadObject1
    {
        ...
        public string IsHomeLoanRequired { get; set; }
