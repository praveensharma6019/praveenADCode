...
{
    public class SeoAboutAdaniHouseContentResolver : Sitecore.LayoutService.ItemRendering.ContentsResolvers.RenderingContentsResolver
    {
        protected readonly INavigationRootResolver RootResolver;

        public SeoAboutAdaniHouseContentResolver(INavigationRootResolver rootResolver)
        {
        ...
        {
            return RootResolver.SeoAboutAdaniHouse(rendering);
