...
{
    public class RoomDetailsFacilitiesCategoriesRootResolver : RenderingContentsResolver
    {
        protected readonly IRoomDetailsRootResolverService RootResolver;

        public RoomDetailsFacilitiesCategoriesRootResolver(IRoomDetailsRootResolverService roomDetailsService)
        {
            this.RootResolver = roomDetailsService;
        }
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            return RootResolver.GetFacilitiesCategoriesDataList(rendering);
        }
    }
}