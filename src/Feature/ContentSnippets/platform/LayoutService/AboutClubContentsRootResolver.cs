...
{
    public class AboutClubContentsRootResolver : RenderingContentsResolver
    {
        protected readonly IClubDetailsRootResolverService RootResolver;

        public AboutClubContentsRootResolver(IClubDetailsRootResolverService clubDetailsService)
        {
            this.RootResolver = clubDetailsService;
        }
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            return RootResolver.GetAboutClubDataList(rendering);
        }
    }
}