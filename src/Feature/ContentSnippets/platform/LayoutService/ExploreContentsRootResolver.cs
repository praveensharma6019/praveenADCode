...
{
    public class ExploreContentsRootResolver : RenderingContentsResolver
    {
        protected readonly IOrderConfirmationRootResolverService RootResolver;

        public ExploreContentsRootResolver(IOrderConfirmationRootResolverService orderConfirmationService)
        {
            this.RootResolver = orderConfirmationService;
        }
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            return RootResolver.GetExploreData(rendering);
        }
    }
}