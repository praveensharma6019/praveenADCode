...
using Adani.SuperApp.Airport.Feature.FNB.Models;
                ...
                else
                {
                    ...
                    foreach (Sitecore.Data.Items.Item outletItem in FilteredOFAQData)
                    {
                        ...
                        _faqModel.title = !string.IsNullOrEmpty(outletItem.Fields[FAQData.Title].Value.ToString()) ? outletItem.Fields[FAQData.Title].Value.ToString() : string.Empty;
                            _faqModel.ctaURL = _helper.GetLinkURL(outletItem, FAQData.CTALink);
                        _faqModel.ctaText = !string.IsNullOrEmpty(outletItem.Fields[FAQData.CTAText].Value.ToString()) ? outletItem.Fields[FAQData.CTAText].Value.ToString() : string.Empty;
