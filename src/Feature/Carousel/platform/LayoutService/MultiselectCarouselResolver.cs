...
{
    public class MultiselectCarouselResolver : Sitecore.LayoutService.ItemRendering.ContentsResolvers.RenderingContentsResolver
    {
        private readonly IMultiselectCarousel businessData;

        public MultiselectCarouselResolver(IMultiselectCarousel ourbusinessData)
        {
        ...
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            ...
            return this.businessData.MultiselectCarouselData(rendering, datasource);
