...
{
    public class GetProjectLocationContentResolver : Sitecore.LayoutService.ItemRendering.ContentsResolvers.RenderingContentsResolver
    {
        private readonly IHeroCarouselService heroCarouselService;

        public GetProjectLocationContentResolver(IHeroCarouselService heroCarouselService)
        {
        ...
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            ...
            return heroCarouselService.GetProjectLocation(rendering, location);
