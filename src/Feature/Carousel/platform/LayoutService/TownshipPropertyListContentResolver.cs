...
{
    public class TownshipPropertyListContentResolver : Sitecore.LayoutService.ItemRendering.ContentsResolvers.RenderingContentsResolver
    {
        private readonly IHeroCarouselService heroCarouselService;

        public TownshipPropertyListContentResolver(IHeroCarouselService heroCarouselService)
        {
        ...
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            ...
            return heroCarouselService.GetTownshipPropertyList(rendering, location);
