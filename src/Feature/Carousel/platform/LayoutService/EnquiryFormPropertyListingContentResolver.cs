...
{
    public class EnquiryFormPropertyListingContentResolver : Sitecore.LayoutService.ItemRendering.ContentsResolvers.RenderingContentsResolver
    {
        private readonly IHeroCarouselService heroCarouselService;

        public EnquiryFormPropertyListingContentResolver(IHeroCarouselService heroCarouselService)
        {
        ...
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            ...
            return heroCarouselService.GetEnquiryFormProperty(rendering);
