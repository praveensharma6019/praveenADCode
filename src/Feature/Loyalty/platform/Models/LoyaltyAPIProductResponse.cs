...
{
    public class LoyaltyAPIProductResponse
    {
        public List<LoyaltyAPIProducts> data { get; set; }
        public bool status { get; set; }
        public string message { get; set; }
        public object warning { get; set; }
        public object error { get; set; }
    }
    public class LoyaltyAPIProducts
    {
        ...
        // Field Added to give the storeType Ticket No 18963
