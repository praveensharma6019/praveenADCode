...
namespace Adani.SuperApp.Airport.Feature.CabVendor.Platform
{
    public class VendorConstant
    {
        ...
        public static readonly Guid CabVendorInfoFolderID = new Guid("{14015189-C801-4E3E-AA90-85D58DF10740}");
        ...
        public static readonly string ReasonsTitleFieldName = "ReasonsTitle";
        ...
        public static readonly ID AirportLocation = new ID("{52D7BA7B-E97B-48E1-B388-DE089CB8AE85}");
        ...
        public static readonly string TitleCab = "Title";
