    ...
    public class AEMLComplaintController : Controller
    {
        ...
        public ActionResult Login(string returnUrl = null)
        {
            ...
            if (Context.User != null && Context.User.IsAuthenticated)
            {
                ...
                var item = Context.Database.GetItem(Templates.ComplaintPortal.ComplaintPortalHomePage);
        ...
        public ActionResult Login(LoginInfoComplaint model, string loginWithCredentials = null, string loginWithOTP = null, string GetOTP = null, string validateOTP = null)
        {
            if (!string.IsNullOrEmpty(loginWithCredentials))
            {
                ...
                return this.Login(model, redirectUrl => new RedirectResult(redirectUrl));
            }
            ...
            else if (!string.IsNullOrEmpty(validateOTP))
            {
                ...
                if (model.AccountNumber == accountNumberValidated.AccountNumber)
                {
                    ...
                    return RedirectPermanent(this.UserProfileService.GetPageURL(Templates.ComplaintPortal.ComplaintPortalHomePage));
                }
            }
            return View(model);
        }

        protected virtual ActionResult Login(LoginInfoComplaint loginInfo, Func<string, ActionResult> redirectAction)
        {
            try
            {
                ComplaintPortalService objComplaintPortalService = new ComplaintPortalService();
                ...
                if (!string.IsNullOrEmpty(adminRole))
                {
                    ...
                    {
                        return RedirectPermanent(this.UserProfileService.GetPageURL(Templates.ComplaintPortal.ComplaintPortalICRSAdminHomePage));
                    }
                    else
                    {
        ...
        public ActionResult Home()
        {
            ...
            catch (Exception e)
            {
                ...
                var item = Context.Database.GetItem(Templates.ComplaintPortal.ComplaintPortalLoginPage);
                return this.Redirect(item.Url());
            }
        }
        ...
        public ActionResult ICRSAdminHome()
        {
            try
            {
                ...
                model.Zones = new List<SelectListItem>();
                var zoneList = model.ComplaintList.Select(c => c.ComplaintZone).Distinct();
                foreach (var z in zoneList)
                {
                    if (!string.IsNullOrEmpty(z))
                        model.Zones.Add(new SelectListItem
                        {
                            Text = z,
                            Value = z
                        });
                ...
                if (!string.IsNullOrEmpty(model.ZoneName))
                    model.ComplaintList = model.ComplaintList.Where(c => c.ComplaintZone == model.ZoneName).ToList();
                return View(model);
            }
            catch (Exception e)
            {
        ...
        [ValidateRenderingId]
        [ValidateAntiForgeryToken]
        public ActionResult ICRSAdminHome(TrackComplaintModel model, string Status, string TATInfo, string ExportReport = null, string GetApplications = null)
        {
            try
            {
                ComplaintPortalService objservice = new ComplaintPortalService();
                ...
                if (!string.IsNullOrEmpty(TATInfo))
                {
                    if (TATInfo == "1")
                        model.ComplaintList = model.ComplaintList.Where(c => c.OrangeRedGreen == 2).ToList();
                    else if (TATInfo == "2")
                        model.ComplaintList = model.ComplaintList.Where(c => c.OrangeRedGreen == 1).ToList();
                    else if (TATInfo == "3")
                        model.ComplaintList = model.ComplaintList.Where(c => c.OrangeRedGreen == 3).ToList();
                }
        ...
        public ActionResult ExportICRSComplaints(string StartDate, string EndDate, string Status, string TATInfo, string ZoneName)
        {
            try
            {
                ComplaintPortalService objservice = new ComplaintPortalService();
                ...
                var ComplaintList = objservice.GetICRSComplaints(startDate, endDate, Status);


                var Zones = new List<SelectListItem>();
                var zoneList = ComplaintList.Select(c => c.ComplaintZone).Distinct();
                foreach (var z in zoneList)
                {
                    if (!string.IsNullOrEmpty(z))
                ...
                if (!string.IsNullOrEmpty(ZoneName))
                    ComplaintList = ComplaintList.Where(c => c.ComplaintZone == ZoneName).ToList();

                if (!string.IsNullOrEmpty(TATInfo))
                {
                    if (TATInfo == "1")
                        ComplaintList = ComplaintList.Where(c => c.OrangeRedGreen == 2).ToList();
                    else if (TATInfo == "2")
                        ComplaintList = ComplaintList.Where(c => c.OrangeRedGreen == 1).ToList();
                    else if (TATInfo == "3")
                        ComplaintList = ComplaintList.Where(c => c.OrangeRedGreen == 3).ToList();
                }

                List<ComplaintDetailsToExport> dataToExport = new List<ComplaintDetailsToExport>();

                foreach (var com in ComplaintList)
                {
                    ComplaintDetailsToExport obj = new ComplaintDetailsToExport
                    {
                        AccountNumber = com.AccountNumber,
                        ComplaintDescription = com.ComplaintDescription.Replace(',', ';'),
                        ComplaintRegistrationNumber = com.ComplaintRegistrationNumber,
                        ComplaintStatusName = com.ComplaintStatusName,
                        ComplaintZone = com.ComplaintZone,
                        CompletionDate = com.CompletionDate,
                        ConsumerName = com.ConsumerName,
                        CreatedDate = com.CreatedDate,
                        Division = com.Division,
                        EscalatedToCGRF = com.EscalatedToCGRF,
                        Level1ComplaintNumber = com.Level1ComplaintNumber,
                        MobileNumber = com.MobileNumber,
                        PMActivityType = com.PMActivityType,
                        TATDate = com.TATDate,
                        TrackingStatus = com.OrangeRedGreen == 1 ? DictionaryPhraseRepository.Current.Get("/ComplaintPortal/TrackingStatus/Upcoming", "Upcoming") : (com.OrangeRedGreen == 2 ? DictionaryPhraseRepository.Current.Get("/ComplaintPortal/TrackingStatus/Passed", "Passed") : DictionaryPhraseRepository.Current.Get("/ComplaintPortal/TrackingStatus/Completed", "Completed")),
                        TATPassedDays = com.TATPassedDays
                    };

                    switch (com.ComplaintSubCategory)
                    {
                        case "M40"://3 days
                            obj.Category = "New connection";
                            obj.SubCategory = "New connection";
                            break;
                        case "M50"://24 hrs
                            obj.Category = "Wrong Disconnection";
                            obj.SubCategory = "Wrong Disconnection";
                            break;
                        case "M51"://24 hrs
                            obj.Category = "Reconnection not done";
                            obj.SubCategory = "Reconnection not done";
                            break;
                        case "M06"://15 days
                            obj.Category = "Billing Complaint";
                            obj.SubCategory = "Wrong tariff plan";
                            break;
                        case "I15"://15 days
                            obj.Category = "Billing Complaint";
                            obj.SubCategory = "Wrong Reading";
                            break;
                        case "M03"://15 days
                            obj.Category = "Billing Complaint";
                            obj.SubCategory = "Wrong Payment";
                            break;
                        case "M04"://15 days
                            obj.Category = "Billing Complaint";
                            obj.SubCategory = "Payment not credited";
                            break;
                        case "M14"://3 days
                            obj.Category = "Billing Complaint";
                            obj.SubCategory = "Bill Not Received";
                            break;
                        case "M24"://15 days
                            obj.Category = "Others";
                            obj.SubCategory = "Others";
                            break;
                        case "M52"://15 days
                            obj.Category = "Billing Complaint";
                            obj.SubCategory = "High consumption complaint";
                            break;
                        case "I01"://15 days
                            obj.Category = "Billing Complaint";
                            obj.SubCategory = "High consumption complaint";
                            break;
                        default:
                            obj.Category = com.ComplaintCategory;
                            obj.SubCategory = com.ComplaintSubCategory;
                            break;
                    }
                    dataToExport.Add(obj);
                }
                var datalist = dataToExport;
                DataTable dtDataTable = ToDataTable(datalist);
                DatatableToCSV(dtDataTable);
            }
            catch (Exception ex)
            {
                Log.Error("Error at TrackComplaint Post " + ex.Message, this);
            }
            var reportPageurl = Context.Database.GetItem(Templates.ComplaintPortal.ComplaintPortalAdminReportsPage).Url();
        ...
        [RedirectUnAuthenticatedComplaintPortal]
        public ActionResult FileComplaint(string complaintNumber = null)
        {
            try
            {
        ...
        [ValidateAntiForgeryToken]
        [RedirectUnAuthenticatedComplaintPortal]
        public ActionResult FileComplaint(ComplaintFileRegistrationModel model, string latCoordinate, string longCoordinate, string SaveAsDraft = null, string SubmitApplication = null, string SubmitFeedbackYes = null, string SubmitFeedbackNo = null, string SubmitFeedback = null, string SubmitFeedbackCancel = null)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(SubmitApplication))
                {
                    ...
                    if (model.AccountNumber == accountNumberValidated.AccountNumber)
                    {
                        ...
                        if (string.IsNullOrEmpty(model.MobileNumber))
                        {
                            ...
                            this.ModelState.AddModelError(nameof(model.ComplaintDescription), DictionaryPhraseRepository.Current.Get("/ComplaintRegistration/mobile number is not registered", "Please register your Mobile number."));
                            model = GetSubcategory(model);
                            return this.View(model);
                        }
        ...
        //[RedirectUnAuthenticatedComplaintPortal]
        //public ActionResult FileComplaintLevel2(string complaintNumber = null)
        //{
        //    try
        //    {
        //        //to do - make it dynamic
        //        UserSession.AEMLComplaintUserSessionContext.ComplaintLevel = "Level2";
        //        ComplaintPortalService objservice = new ComplaintPortalService();
        //        ComplaintFileRegistrationModel model = new ComplaintFileRegistrationModel();
        ...
        //            MobileNumber = userDetails.Mobile,
        //            Pincode = userDetails.PinCode,
        //            ZoneName = userDetails.Vertrag_Contract
        //        };
        ...
        //[ValidateRenderingId]
        //[ValidateAntiForgeryToken]
        //public ActionResult FileComplaintLevel2(ComplaintFileRegistrationModel model, string ValidateComplaintNumber = null, string SaveAsDraft = null, string SubmitApplication = null)
        //{
        //    try
        //    {
        //        ComplaintPortalService complaintPortalService = new ComplaintPortalService();
        ...
        //            var complaintDetails = complaintPortalService.ValidateComplaintFromPreviousLevel(model.ComplaintFromPreviousLevel);
        ...
        //                    Address = userDetails.Street + userDetails.Street2 + userDetails.Street3,
        //                    City = userDetails.City,
        //                    ConsumerName = complaintDetails.ConsumerName,
        //                    EmailId = complaintDetails.EmailId,
        //                    MobileNumber = complaintDetails.MobileNumber,
        //                    Pincode = complaintDetails.Pincode,
        ...
        //                    SelectedComplaintSubCategory = complaintDetails.SelectedComplaintSubCategory,
        ...
        //            else
        //            {
        //                this.ModelState.AddModelError(nameof(model.ComplaintFromPreviousLevel), DictionaryPhraseRepository.Current.Get("/ComplaintRegistration/ComplaintFromPreviousLevel not valid", "Complaint number is not valid."));
        ...
        //        if (!string.IsNullOrEmpty(SaveAsDraft))
        //        {
        //            HttpPostedFileBase file = Request.Files["fileComplaintDoc"];
        //            if (file != null && file.ContentLength > 0)
        //            {
        //                if (!complaintPortalService.CheckExtension(file))
        //                {
        ...
        //                }
        //            }
        //            string registrationNumber = complaintPortalService.SaveComplaintApplication(model, file, UserSession.AEMLComplaintUserSessionContext.ComplaintLevel, false);
        ...
        //                }
        //            }
        //            string registrationNumber = complaintPortalService.SaveComplaintApplication(model, file, UserSession.AEMLComplaintUserSessionContext.ComplaintLevel, true);
        //            //sap integration
        ...
        //            if (!string.IsNullOrEmpty(registrationNumber))
        //            {
        //                string TATDuration = DictionaryPhraseRepository.Current.Get("/ComplaintRegistration/TAT/CGRFApplictionSubmit", "5 business days");

        //                ViewBag.IsSuccessful = true;
        //                ViewBag.IsSubmit = true;

        //                //to do  - sap complaint number to be passed here
        //                string messagetobedisplayed = string.Format(DictionaryPhraseRepository.Current.Get("/ComplaintRegistration/PopupMessageOnSubmit", "Your complaint is registered successfully. The complaint can be checked via the Track Complaints Section on the Home screen with Complaint Reference No. {0}. Your complaint will be resolved in 5 business days."), registrationNumber);

        //                ViewBag.Message = messagetobedisplayed;

        //                Session["Message"] = messagetobedisplayed;

        //                bool isEmailSent = complaintPortalService.SendSMSandEmailtoConsumer(model.MobileNumber, model.EmailId, model.AccountNumber, registrationNumber, TATDuration, (int)ComplaintPortalService.ActionType.Submit);
        ...
        //[RedirectUnAuthenticatedComplaintPortal]
        //public ActionResult FileComplaintLevel3(string complaintNumber = null)
        //{
        //    try
        //    {
        //        //to do - make it dynamic
        //        UserSession.AEMLComplaintUserSessionContext.ComplaintLevel = "Level3";
        //        ComplaintPortalService objservice = new ComplaintPortalService();
        //        ComplaintFileRegistrationModel model = new ComplaintFileRegistrationModel();
        ...
        //[ValidateRenderingId]
        //[ValidateAntiForgeryToken]
        //public ActionResult FileComplaintLevel3(ComplaintFileRegistrationModel model, string ValidateComplaintNumber = null, string SaveAsDraft = null, string SubmitApplication = null)
        //{
        //    try
        //    {
        //        ComplaintPortalService complaintPortalService = new ComplaintPortalService();
        ...
        [RedirectUnAuthenticatedComplaintPortal]
        public ActionResult CGRFTrackComplaint()
        {
            TrackComplaintModel model = new TrackComplaintModel();
            ComplaintPortalService objservice = new ComplaintPortalService();
        ...
        [RedirectUnAuthenticatedComplaintPortal]
        public ActionResult CGRFFileComplaint(string complaintNumber = null, string esc = null)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(complaintNumber))
                {
                    if (!string.IsNullOrEmpty(esc) && esc == "1")
                    {
                        ...
                        if (complaints.Any(c => c.ComplaintNumber == complaintNumber))
                        {
                            var comp = complaints.FirstOrDefault(c => c.ComplaintNumber == complaintNumber);
                            ...
                            {
                                this.Session["UpdateMessage"] = new InfoMessage(DictionaryPhraseRepository.Current.Get("/COmplaintPortal/No CGRf Redirection", "Complaint cannot be escalated to CGRF, please contact administrator!"));
                                var item = Context.Database.GetItem(Templates.ComplaintPortal.ComplaintPortalTrackComplaintPage);
                                return this.Redirect(item.Url());
                            }
                        }
        ...
        [ValidateAntiForgeryToken]
        [RedirectUnAuthenticatedComplaintPortal]
        public ActionResult CGRFFileComplaint(CGRFComplaintFileRegistrationModel model, string ValidateComplaintNumber = null, string SaveAsDraft = null, string SubmitApplication = null, string Resubmit = null, string Rejoinder = null, string OrderReviewRequest = null)
        {
            try
            {
                ComplaintPortalService complaintPortalService = new ComplaintPortalService();
                ...
                if (!string.IsNullOrEmpty(ValidateComplaintNumber))
                {
                    ...
                    var comp = complaints.FirstOrDefault(c => c.ComplaintNumber == complaintNumberInput);
