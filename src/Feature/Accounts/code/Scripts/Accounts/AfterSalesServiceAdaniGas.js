                            ...
                            if (data.Quantity_Min != "00" && data.Quantity_Max != "00") {
                                if (data.Msgflag === "F") {
                                    ...
                                    if (data.extraamount != undefined && data.extraamount != "") {
                                        var txt1 = "₹ " + data.AmountToBePaid + " (inclusive of Tax ₹ " + data.Tax + "). \n Extra Pipe charges of ₹ " + data.extraamount + " per meter(Incl.tax) will be charged beyond " + data.MaxLengthgas + " meter length. " + "In case of refund, visit charges Rs 250 + tax will be deducted from amount paid.";
