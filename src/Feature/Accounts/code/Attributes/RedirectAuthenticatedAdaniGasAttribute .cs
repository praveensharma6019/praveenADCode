namespace Sitecore.Feature.Accounts.Attributes
{
    ...
    public class RedirectAuthenticatedAdaniGasAttribute : ActionFilterAttribute
    {
        private readonly IGetRedirectUrlService getRedirectUrlService;

        public RedirectAuthenticatedAdaniGasAttribute() : this(ServiceLocator.ServiceProvider.GetService<IGetRedirectUrlService>())
        {
        }

        public RedirectAuthenticatedAdaniGasAttribute(IGetRedirectUrlService getRedirectUrlService)
        {
