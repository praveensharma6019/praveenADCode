        ...
        public bool CreateItem(TemplateData templateData)
        {
            ...
            using (new SecurityDisabler())
            {
                ...
                try
                {
                    ...
                    Log.Info("TemplateItem  masterDb" + masterDb, masterDb);
                    var parentId = Sitecore.Data.ID.Parse(templateData.parentItem);
                    Log.Info("TemplateItem  parentId" + parentId, parentId);
                    var parentName = masterDb.GetItem(parentId);
                    Log.Info("TemplateItem  parentName" + parentName, parentName);
                    Sitecore.Data.Serialization.Manager.DumpTree(parentName);
                    parentName = masterDb.GetItem(parentId);
                    Log.Info("TemplateData Recevied from parentName" + parentName, parentName);
                    ...
                    Log.Info("TemplateData templateItem name" + templateItem, templateItem);
                    ...
                    if (templateItem != null)
                    {
                        ...
                        Log.Info("TemplateItem  newItem" + newItem, newItem);
