...
{
    public class JobDetailResolver : RenderingContentsResolver
    {
        private readonly IJobDetailService jobdetailService;
        public JobDetailResolver(IJobDetailService jobdetailService)
        {
            this.jobdetailService = jobdetailService;
        }
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            return jobdetailService.GetJobDetails(rendering.Item);
