...
$(document).ready(function(){
    ...
    $("#submittop").click(function (e) {
        ...
        if ($("#mobile").val().length != 10 || regex_special_num.test($("#mobile").val()) == false) {
        ...
        if (!$("#country_code").val()) {
            $(".err_msg").html('Please Enter Your Country Name!');
            return false;
        }
        if ($("#tnc").prop("checked") == false) {
            $(".err_msg").html('Please Check term and conditions!');
            return false;
        }
        ...
        var savecustomdata = {
            ...
            FormType: "MiracleMileInquriyForm",
            PageInfo: pageinfo,
        ...
        $.ajax({
            ...
            url: "/api/MiracleMile/Insertcontactdetail",
            contentType: "application/json",
            success: function (data) {
                $(".err_msg").html('Your inquriy submitted sucessfully');
    ...
    $("#submitfooter").click(function (e) {
        ...
        if (email_regex.test($("#email2").val()) == false) {
            $("#err_msg").html("Please enter proper Email ID!");
            return false;
        }
        ...
        var savecustomdata = {
            ...
            FormType: "MiracleMileFooterForm",
            PageInfo: pageinfo,
            FormSubmitOn: currentdate,
            LeadSource: "Web to Lead"
