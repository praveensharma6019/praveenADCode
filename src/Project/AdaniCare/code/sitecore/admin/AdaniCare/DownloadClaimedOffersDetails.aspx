    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadClaimedOffersDetails.aspx.cs" Inherits="Sitecore.AdaniCare.Website.sitecore.admin.AdaniCare.DownloadClaimedOffersDetails" %>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-right">
                            <h4 class="font-weight-bold mt-2"><span class="txt-orange">Download Claimed Offer details</span></h4>
                        </div>
                    </div>
                    <!-- /Welcome Message -->
                    <div class="py-2"></div>
