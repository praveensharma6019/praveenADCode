...
function playPause1() {
    if (video1.paused) {
        video1.play();
        $('.videoplayButton1').addClass('d-none');
    } else {
        video1.pause();
        $('.videoplayButton1').removeClass('d-none');

    }
}

// manufactureing video
var videoHome = document.getElementById("myVideoHome");



function playPauseHome() {
    if (videoHome.paused) {
        videoHome.play();
        $('.videoplayButtonHome').addClass('d-none');
    } else {
        videoHome.pause();
        $('.videoplayButtonHome').removeClass('d-none');
