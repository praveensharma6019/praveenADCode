...
//    $(element).closest('.input-group').parent().removeClass('has-success').addClass('has-error');
// },
// unhighlight: function(element) {
//   $(element).closest('.input-group').parent().removeClass('has-error').addClass('has-success');
// },
...
// var fname = $('#ContactForm').find("[name='name']").val();
// var enuiryemail = $('#ContactForm').find("[name='email']").val();
// var enuirymobile = $('#ContactForm').find("[name='mobile']").val();
// var budget = 0.0;
// var remarks = "";
// var country = $('#ContactForm').find("[name='CountryCode']").val();
// var model = {
// mobile: enuirymobile,
// first_name: fname,
// // last_name: lastname,
...
// if (data.status == "1") {
// //create json object
// var countryname = $('#ContactForm').find("[name='CountryCode']").val();
// //$('#country :selected').text();
// // var statename = $('#state :selected').text();
// var currentdate = new Date().toISOString().slice(0, 19).replace('T', ' ');
// var formtype = $('#ContactForm').find("[id='FormType']").val();
// var pageinfo = ($('#ContactForm').find("[id='PageInfo']").val()).replace("/", "");
// // ($('#PageInfo').val()).replace("/", "");
// var propertytype = "";
// var propertilocation = "";
// var saletype = "";
// var utmSource = $('#ContactForm').find("[id='utm_source']").val();
...
// //$('#ContactForm').find("[id='retURL']").val($('#ContactForm').find("[id='retURL']").val() + "?prop=" + selectedproperty);
// //$('#retURL').val($('#retURL').val() + "?prop=" + selectedproperty);
// //window.location.href = $('#ContactForm').find("[id='retURL']").val();
// //$('#ContactForm').submit();
// form.submit();
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.status == "1") {
                                        ...
                                        var propertytype = "Western Heights";
                                        var propertilocation = "";
                                        var SalesSource = $('#PopupForm').find("[name='sales_source']").val();
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (opdata) {
                                                ...
                                                if (opdata.status == "1") {
                                                    ...
                                                    window.location.href = "https://www.adanirealty.com/western-heights-thankyou";
