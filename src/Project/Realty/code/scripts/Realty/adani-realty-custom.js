...
//            data: { PropName: propValue, PropertyType: z },
//            success: function (obj) {
//                $('#CarpetArea').text(obj.PropertyTypes[0].CarpetArea);
//                $('#StartingPrice').text(obj.PropertyTypes[0].BookingPrice);
//                $('#BookingAmount').text(obj.PropertyTypes[0].BookingAmount);
//            },
//            error: function () {
//                alert("error");
//            }
...
$("#SubmitRentalForm").click(function (e) {
