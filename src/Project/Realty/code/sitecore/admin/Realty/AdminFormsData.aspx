<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFormsData.aspx.cs" Inherits="Sitecore.Realty.Website.sitecore.admin.Realty.AdminFormsData" %>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <asp:DropDownList ID="drptype" runat="server" class="form-control">
                                    ...
                                    <asp:ListItem Value="Atelier Greens">Atlier Greens</asp:ListItem>
                                    <asp:ListItem value="Western Height">Western Heights</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
