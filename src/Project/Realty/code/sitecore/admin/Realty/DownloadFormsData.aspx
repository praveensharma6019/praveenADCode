<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadFormsData.aspx.cs" Inherits="Sitecore.Realty.Website.sitecore.admin.Realty.DownloadFormsData" %>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <asp:DropDownList ID="drptype" runat="server" class="form-control">
                                    ...
                                    <asp:ListItem value="/move-in-to-shantigram">Move in to Shantigram</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
