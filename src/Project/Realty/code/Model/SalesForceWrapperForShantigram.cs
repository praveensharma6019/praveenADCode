...
{
    public class SalesForceWrapperForShantigram
    {
        ...
        public SalesForceWrapperForShantigram()
        {
            try
            {
                Sitecore.Data.Database dbWeb = Sitecore.Configuration.Factory.GetDatabase("web");

                Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - get configuration", this);
                ...
                Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - get Configuration done: " + ConsumerKey + "," + ConsumerSecret + "," + Username + "," + Password + "," + TokenUrl, this);
                ...
                Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - get Token call", this);
                GetToken();
            }
            catch (Exception e)
            {
                Sitecore.Diagnostics.Log.Error("Move In Shantigram - Salesforce Web lead generation - get configuration" + e.Message, this);
            }
        }
        ...
        public void GetToken()
        {
            ...
            try
            {
                ...
                Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - get token - get response", this);
                ...
                Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - get token - " + Token+","+EndPoint, this);
            }
            catch (Exception ex)
            {
                //throw ex;
                Sitecore.Diagnostics.Log.Error("Move In Shantigram - Salesforce Web lead generation - get token - get response Failed" + ex.Message, this);
                //WriteLine(exception);
            }
        ...
        public dynamic GenerateLead(LeadObjectForShantigram objs)
        {
            string result;
            try
            {
                var req = (HttpWebRequest)WebRequest.Create("https://ap13.salesforce.com/a3t2u000000Ch13");
                Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - generate lead: " + req, this);
                req.ContentType = "application/json";
               req.Accept = "application/json";
                req.Method = "POST";
                List<LeadObjectForShantigram> t = new List<LeadObjectForShantigram>();
                t.Add(objs);
                using (var streamWriter = new StreamWriter(req.GetRequestStream()))
                {
                    string jsonStr = JsonConvert.SerializeObject(t);
                    Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - generate lead: " + jsonStr, this);
                ...
                using (var streamReader1 = new StreamReader(httpResponse.GetResponseStream()))
                {
                    ...
                    Sitecore.Diagnostics.Log.Info("Move In Shantigram - Salesforce Web lead generation - generate lead:" + result, this);
                }
                return result;
            }
    ...
    public class LeadObjectForShantigram
    {
