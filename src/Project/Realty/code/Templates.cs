...
namespace Sitecore.Realty.Website
{
    ...
    {
        public struct RentalFormFields
        {
            public static readonly ID ApartmentSizeList = new ID("{128156FE-6A3E-488F-9426-F9BB7CF3CF01}");
            public static readonly ID ApartmentTypeList = new ID("{7E0BBE64-B075-4987-8915-C82C065489B8}");
        }
