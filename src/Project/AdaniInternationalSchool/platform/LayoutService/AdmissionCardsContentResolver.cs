...
{
    public class AdmissionCardsContentResolver : RenderingContentsResolver
    {
        private readonly IAISAdmissionPageServices RootResolver;

        public AdmissionCardsContentResolver(IAISAdmissionPageServices aboutCareerServices)
        {
        ...
        {
            return RootResolver.GetAdmissionCards(rendering);
        }
    }
}