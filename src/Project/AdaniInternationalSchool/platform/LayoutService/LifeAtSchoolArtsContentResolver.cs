...
{
    public class LifeAtSchoolArtsContentResolver : RenderingContentsResolver
    {
        private readonly IAISLifeAtSchoolPageServices RootResolver;

        public LifeAtSchoolArtsContentResolver(IAISLifeAtSchoolPageServices aboutCareerServices)
        {
        ...
        {
            return RootResolver.GetLifeAtSchoolArts(rendering);
        }
    }
}