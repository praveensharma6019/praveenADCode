...
{
    public class SteamCardContentResolver : RenderingContentsResolver
    {
        private readonly IAISLearningPageServices RootResolver;

        public SteamCardContentResolver(IAISLearningPageServices aboutCareerServices)
        {
        ...
        {
            return RootResolver.GetSteamCard(rendering);
        }
    }
}