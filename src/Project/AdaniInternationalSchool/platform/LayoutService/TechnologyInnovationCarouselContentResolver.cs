...
{
    public class TechnologyInnovationCarouselContentResolver : RenderingContentsResolver
    {
        private readonly IAISLearningPageServices RootResolver;

        public TechnologyInnovationCarouselContentResolver(IAISLearningPageServices aboutCareerServices)
        {
        ...
        {
            return RootResolver.GetTechnologyInnovation(rendering);
        }
    }
}