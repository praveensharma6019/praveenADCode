...
{
    public class FacilitiesContentResolver : RenderingContentsResolver
    {
        private readonly IAISLearningPageServices RootResolver;

        public FacilitiesContentResolver(IAISLearningPageServices aboutCareerServices)
        {
        ...
        {
            return RootResolver.GetFacilities(rendering);
        }
    }
}