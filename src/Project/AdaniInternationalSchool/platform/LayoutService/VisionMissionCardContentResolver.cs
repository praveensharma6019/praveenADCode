...
{
    public class VisionMissionCardContentResolver : RenderingContentsResolver
    {
        private readonly IAdaniInternationalSchoolServices RootResolver;

        public VisionMissionCardContentResolver(IAdaniInternationalSchoolServices visionMissionData)
        {
        ...
        {
            return RootResolver.GetVisionMissionCard(rendering);
        }
    }
}