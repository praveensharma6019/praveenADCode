...
{
    public class AdmissionOverviewContentResolver : RenderingContentsResolver
    {
        private readonly IAISAdmissionPageServices RootResolver;

        public AdmissionOverviewContentResolver(IAISAdmissionPageServices aboutCareerServices)
        {
        ...
        {
            return RootResolver.GetAdmissionOverview(rendering);
        }
    }
}