...
{
    public class WhyUsCardContentResolver : RenderingContentsResolver
    {
        private readonly IContentResolverService _contentResolverService;
        public WhyUsCardContentResolver(IContentResolverService contentResolverService)
        {
            _contentResolverService = contentResolverService;
        }
        public override object ResolveContents(Rendering rendering, IRenderingConfiguration renderingConfig)
        {
            return _contentResolverService.GetWhyUsCardModel(rendering);
        }
    }
}