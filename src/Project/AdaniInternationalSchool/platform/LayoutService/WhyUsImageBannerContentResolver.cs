...
{
    public class WhyUsImageBannerContentResolver : RenderingContentsResolver
    {
        private readonly IAdaniInternationalSchoolServices RootResolver;

        public WhyUsImageBannerContentResolver(IAdaniInternationalSchoolServices visionMissionData)
        {
        ...
        {
            return RootResolver.GetWhyUsImageBanner(rendering);
        }
    }
}