...
using System.IO;
using System.Web;
using static Project.AdaniInternationalSchool.Website.Models.AzureBlobStorageModel;
...
namespace Project.AdaniInternationalSchool.Website.Helpers
{
    public class AzureBlobStorageServices
    {
        public byte[] GetFileFromAzure(string fileName)
        {
            ...
            //string connection = "https://azadldevemailimagesa.blob.core.windows.net/corpsites-sitecore-storage?si=Corpsites-storage-policy&spr=https&sv=2021-06-08&sr=c&sig=lgYidomfrvygH1H%2FwCDbyUqlng9As3DtWCzxcbMYn40%3D";
            //string containerString = "corpsites-sitecore-storage";
