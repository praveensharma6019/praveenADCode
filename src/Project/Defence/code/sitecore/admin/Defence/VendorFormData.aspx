<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorFormData.aspx.cs" Inherits="Sitecore.Defence.Website.sitecore.admin.Defence.VendorFormData" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 mx-auto vertical-middle">
                <p class="txt-center">
                    <img src="/-%2Fmedia%2F8417C69EFC1A48D8B3AF36789286C644.ashx" alt="Adani Realty" disablewebedit="False">
                </p>
