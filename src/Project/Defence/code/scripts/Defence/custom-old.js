...
$(document).ready(function(){
	if(window.location.href == "https://stage.adanidefence.com/careers")
	{

$('select[name^="MessageType"] option[value="Careers"]').attr("selected","selected");
 $("#ResumeAttached").show();
	}
else if (window.location.href == "https://stage.adanidefence.com/newsroom")
{
...
$(document).ready(function(){
          ...
          if(pageURL == "https://stage.adanidefence.com/terms-and-conditions")
          {
            $('.headerSec').addClass("headerSec-inner");
         }
 if(pageURL == "https://stage.adanidefence.com/disclaimer")
          {
            $('.headerSec').addClass("headerSec-inner");
         }
