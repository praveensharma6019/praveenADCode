...
{
    public class AboutAirportContentResolver : RenderingContentsResolver
    {
        private readonly IHomeService rootResolver;

        public AboutAirportContentResolver(IHomeService HomedataResolver)
        {
        ...
        {
            return rootResolver.GetAboutAirport(rendering);
        }
    }
}