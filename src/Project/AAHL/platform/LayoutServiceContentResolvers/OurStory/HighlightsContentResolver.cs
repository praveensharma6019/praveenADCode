...
{
    public class HighlightsContentResolver : RenderingContentsResolver
    {
        private readonly IOurStory rootResolver;

        public HighlightsContentResolver(IOurStory HomedataResolver)
        {
        ...
        {
            return rootResolver.GetHighlights(rendering);
        }
    }
}