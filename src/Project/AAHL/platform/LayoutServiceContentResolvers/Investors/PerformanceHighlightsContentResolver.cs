...
{
    public class PerformanceHighlightsContentResolver : RenderingContentsResolver
    {
        private readonly IInvestorsServices RootResolver;

        public PerformanceHighlightsContentResolver(IInvestorsServices investorsServices)
        {
        ...
        {
            return RootResolver.GetPerformance(rendering);
        }
    }
}