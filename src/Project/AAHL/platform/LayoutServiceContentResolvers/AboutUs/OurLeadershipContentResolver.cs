...
{
    public class OurLeadershipContentResolver : RenderingContentsResolver
    {
        private readonly IAboutUsServices RootResolver;

        public OurLeadershipContentResolver(IAboutUsServices aboutUsServices)
        {
        ...
        {
            return RootResolver.GetOurLeadership(rendering);
        }
    }
}