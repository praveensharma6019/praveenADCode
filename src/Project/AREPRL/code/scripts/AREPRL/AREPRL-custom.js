...
(function($, window, document) { 'use strict';
 ...
 if (window.location.href.indexOf("#MonthlySolarResourcesBhadlaSolarPark") > 0) {
    $('#accordion9 .card-header').removeClass("collapsed");
		$('#accordion9 .card-body').addClass("show");
        $('html, body').animate({
            scrollTop: $("#accordion-parents").offset().top
                - 130
        }, 1000);
    }
	
	 if (window.location.href.indexOf("#MonthlySolarResourcesFatehgarhSolarPark") > 0) {
    $('#accordion8 .card-header').removeClass("collapsed");
		$('#accordion8 .card-body').addClass("show");
        $('html, body').animate({
            scrollTop: $("#accordion-parents").offset().top
                - 130
        }, 1000);
...
$(document).ready(function () {
	...
	$('.ft-business li a').click(function () {
	 ...
	 if (window.location.href.indexOf("#ProjectsAtGlancess") > 0) {
		$('#accordion1 .card-header').removeClass("collapsed");
		$('#accordion1 .card-body').addClass("show");
        $('html, body').animate({
            scrollTop: $("#accordion-parent").offset().top
                - 130
        }, 1000);
	...
	if (window.location.href.indexOf("#ComparisonofAREPRLwithothers") > 0) {
      $('#accordion2 .card-header').removeClass("collapsed");
		$('#accordion2 .card-body').addClass("show");
        $('html, body').animate({
            scrollTop: $("#accordion-parent").offset().top
                - 130
        }, 1000);
    }
	 if (window.location.href.indexOf("#PowerEvacuationTransmissions") > 0) {
      $('#accordion3 .card-header').removeClass("collapsed");
		$('#accordion3 .card-body').addClass("show");
        $('html, body').animate({
            scrollTop: $("#accordion-parent").offset().top
                - 130
        }, 1000);
    }
	 if (window.location.href.indexOf("#PowerEvacuationTransmissionFatehgarhs") > 0) {
    $('#accordion4 .card-header').removeClass("collapsed");
		$('#accordion4 .card-body').addClass("show");
        $('html, body').animate({
            scrollTop: $("#accordion-parent").offset().top
                - 130
        }, 1000);
