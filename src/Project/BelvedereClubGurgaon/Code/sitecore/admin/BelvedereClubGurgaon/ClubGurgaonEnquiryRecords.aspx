<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClubGurgaonEnquiryRecords.aspx.cs" Inherits="Sitecore.BelvedereClubGurgaon.Website.sitecore.admin.BelvedereClubGurgaon.ClubGurgaonEnquiryRecords" %>
...
.txt-red{color:red;}
    ...
    <!-- Bootstrap core CSS -->
    <link href="/styles/BelvedereClubGurgaon/bootstrap.min.css" rel="stylesheet" />
...
<body>
      <div class="container">
                <div class="row">
                                <div class="col-4 mx-auto vertical-middle">
                                                ...
                                                <p class="txt-center"><img src="../../../images/BelvedereClubGurgaon/logo-club.png" alt="Belvedere Club Gurgaon" disablewebedit="False" /></p>
    ...
    <script src="/scripts/BelvedereClubGurgaon/jquery.min.js"></script>
    <script src="/scripts/BelvedereClubGurgaon/bootstrap.min.js"></script>
</body>
</html>
