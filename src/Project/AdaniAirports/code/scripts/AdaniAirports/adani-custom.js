...
$('.sitemap-link').click(function() {
	...
	$('.headerSec .website_dropdown').removeClass('show');
	$('.headerSec .website_dropdown .dropdown-menu').removeClass('show');
	...
	if(data.current_observation != null)
	{
		if(data.current_observation.condition != null)
		{
			...
			console.log(data.current_observation.condition.temperature);
				$('#tempInfo').html('<img alt="" src="-/media/DD804E86BFD845498AD5FADA9FFDDCF7.ashx"> <span>' + data.current_observation.condition.temperature +'</span><span>&#8451;</span>')
...
$('.loadmore_section .readmore_btn').click(function (){
	$('.readmore_btn').toggleClass('d-inline-block');
	$('.loadmore_section p.d-none').toggleClass('d-block');
});
...
$('.website_dropdown button').click(function(){
$('#mainMenu').removeClass('show');
})

$('.website_dropdown.show button').click(function(){
