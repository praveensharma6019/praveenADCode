...
{
    public class AdaniCapitalWebAPIServices
    {
        ...
        public AdaniCapitalContactUsModal FreshDeskContactUsCreateTicket(AdaniCapitalContactUsModal model)
        {
            try
            {
            ...
            {
                Log.Error("Error in Method - Store Adani Capital Contact Us form in Freshdesk : :" + model.EmailID + e.Message, this);
                return model;
            }
        ...
        public BecomeAPartnerModel FreshDeskBecomePartnerCreateTicket(BecomeAPartnerModel model)
        {
            try
            {
                ...
                catch (WebException ex)
                {
                    ...
                    using (var reader = new StreamReader(stream))
                    {
                        Console.Write("Error Response Adani Capital Become A Partner form in Freshdesk: ");
                        Console.WriteLine(reader.ReadToEnd());
                    }
                }
                return model;
            ...
            {
                Log.Error("Error in Method - Store Adani Capital Become A Partner form in Freshdesk : :" + model.EmailID + e.Message, this);
                return model;
            }
        ...
        public AdaniCapitalApplyforLoanModel ApplyForLoanCreateEnquiry(AdaniCapitalApplyforLoanModel model)
        {
            try
            {
            ...
            {
                Log.Error("Error in Method - Store Adani Capital ApplyForLoan form in LeadManagementSystem : :" + model.EmailID + e.Message, this);
                return model;
            }
        }
        ...
        public RequestCallbackModel FreshDeskReqCallbackTicket(RequestCallbackModel model)
        {
            ...
            {
                Log.Error("Error in Method - Store Adani Capital RequestCallback form in Freshdesk : :" + model.EmailID + e.Message, this);
                return model;
            }
        }
        public FreshdeskCreateTicketModel FreshDeskCreateTicket(FreshdeskCreateTicketModel model)
        {
            ...
            {
                Log.Error("Error in Method - Store Adani Capital FreshDeskCreateTicket form in Freshdesk : :" + model.EmailID + e.Message, this);
                return model;
            }
        }//public AdaniCapitalApplyforLoanModel FreshDeskApplyForLoanTicket(AdaniCapitalApplyforLoanModel model)
        //{
        //    try
        //    {
        //        model.IsSubmittedToFreshdesk = false;
        ...
        //    catch (Exception e)
        //    {
        //        Log.Error("Error in Method - Store Adani Capital ApplyForLoan form in Freshdesk : :" + model.EmailID + e.Message, this);
        //        return model;
        //    }
        //}
        ...
        public LoginInfoModel LMSGetLoans(LoginInfoModel loginInfoModel)
        {
            try
            {
                Log.Info("Start service Method - GetLoans Adani Capital LMS login :" + loginInfoModel.MobileNoOrLoanAccountNumberValue, this);
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    Log.Info("Received Token for GetLoans Adani Capital LMS login :" + AccessToken, this);
                }
...
" + "\n";
                ...
                if (response.IsSuccessful)
                {
                    Log.Info("Received Data Success for GetLoans Adani Capital LMS login :" + response.Content, this);
                    var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                    ...
                    if (responseObj["success"] != null)
                    {
                        ...
                        {
                            Log.Info("Received Data Error for GetLoans Adani Capital LMS login :" + response.Content, this);
                    ...
                    {
                        Log.Info("Received Data Error for Get_Loan_Details Adani Capital LMS login :" + response.Content, this);
                ...
                {
                    Log.Info("Service Response not successfull for GetLoans Adani Capital LMS login :" + response.Content, this);
                    loginInfoModel.IsAccountValid = false;
                }
            }
            catch (Exception e)
            {
                Log.Error("Error in Method - GetLoans Adani Capital LMS login :" + loginInfoModel.MobileNoOrLoanAccountNumberValue + e.Message, this);
            }
        ...
        public LoginInfoModel LMSGet_Loan_Details(LoginInfoModel loginInfoModel)
        {
            try
            {
                ...
                {
                    Log.Info("Start service Method - Get_Loan_Details Adani Capital LMS login :" + loginInfoModel.MobileNoOrLoanAccountNumberValue, this);
                    loginInfoModel.Message = DictionaryPhraseRepository.Current.Get("/Controller/Messages/NoUserFound", loginInfoModel.MobileNoOrLoanAccountNumber + " not found");
                    return loginInfoModel;
                }                
            }
            ...
            {
                Log.Error("Error in Method - Get_Loan_Details Adani Capital LMS login :" + loginInfoModel.MobileNoOrLoanAccountNumberValue + e.Message, this);
                return loginInfoModel;
            }
            try
            {
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    AccessToken = jServiceResponse.Value<string>("access_token");
                    request.AddHeader("access_token", AccessToken);
                    Log.Info("Received Token for Get_Loan_Details Adani Capital LMS login :" + AccessToken, this);
                }
 ...
 " + "\n" +
                ...
                if (response.IsSuccessful)
                {
                    Log.Info("Received Data Success for Get_Loan_Details Adani Capital LMS login :" + response.Content, this);
                    var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                    //var responseObj2 = JsonConvert.DeserializeObject<JObject>(response.Content);
                    //if (responseObj.error != null) throw new Exception(responseObj.error_description);
                    //var j = Newtonsoft.Json.Linq.JArray.Parse(responseObj);
                ...
                {
                    Log.Info("Service Response not successfull for Get_Loan_Details Adani Capital LMS login :" + response.Content, this);
                    loginInfoModel.IsAccountValid = false;
                }
            }
            catch (Exception e)
        ...
        public LoginInfoModel LMSGet_UserIdentityDetails(LoginInfoModel loginInfoModel)
        {
            try
            {
                Log.Info("Start service Method - LMSGet_UserIdentityDetails Adani Capital LMS login :" + loginInfoModel.LoanAccountNumber, this);
                string requestURL = LMSServiceURL + LMSget_loan_details;
                var client = new RestClient(requestURL);
                client.Timeout = -1;
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    Log.Info("Received Token for LMSGet_UserIdentityDetails Adani Capital LMS login :" + AccessToken, this);
                }
                string body = "";
 ...
 " + "\n" +
                    @"}";
                            ...
                            if (response.IsSuccessful)
                            {
                                Log.Info("Received Data Success for LMSGet_UserIdentityDetails Adani Capital LMS login :" + response.Content, this);
                                var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                                //var responseObj2 = JsonConvert.DeserializeObject<JObject>(response.Content);
                                //if (responseObj.error != null) throw new Exception(responseObj.error_description);
                                //var j = Newtonsoft.Json.Linq.JArray.Parse(responseObj);
                                ...
                                {
                                    Log.Info("Received Data Error for LMSGet_UserIdentityDetails Adani Capital LMS login :" + response.Content, this);
                                }
                            }
                            else
                            {
                                Log.Info("Service Response not successfull for LMSGet_UserIdentityDetails Adani Capital LMS login :" + response.Content, this);
                            }
                        }
                    }
                }
            ...
            {
                Log.Error("Error in Method - LMSGet_UserIdentityDetails Adani Capital LMS login :" + loginInfoModel.MobileNoOrLoanAccountNumberValue + e.Message, this);
            }
            return loginInfoModel;
        }
        ...
        public LoginInfoModel UpdateAssocitedLoanList(LoginInfoModel loginInfoModel)
        {
            ...
            {
                Log.Error("Error in Method - AddLoanList Adani Capital LMS login :" + loginInfoModel.MobileNoOrLoanAccountNumberValue + e.Message, this);
            }
            return loginInfoModel;
        }
        ...
        public ReportsModel LMSGenerate_SOA_Report(string LANno)
        {
            ...
            try
            {
                Log.Info("Start service Method - LMSGenerate_SOA_Report Adani Capital LMS login :" + LANno, this);
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    AccessToken = jServiceResponse.Value<string>("access_token");
                    request.AddHeader("access_token", AccessToken);
                    Log.Info("Received Token for LMSGenerate_SOA_Report Adani Capital LMS login :" + AccessToken, this);
                }
 ...
 " + "\n" +
                ...
                if (response.IsSuccessful)
                {
                    Log.Info("Received Data Success for LMSGenerate_SOA_Report Adani Capital LMS login :" + response.Content, this);
                    var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                    ...
                    {
                        Log.Info("Received Data Error for LMSGenerate_SOA_Report Adani Capital LMS login :" + response.Content, this);
                ...
                {
                    Log.Info("Service Response not successfull for LMSGenerate_SOA_Report Adani Capital LMS login :" + response.Content, this);
                    reportsModel.IsRequestValid = false;
                }
            }
            catch (Exception e)
            {
                Log.Error("Error in Method - LMSGenerate_SOA_Report Adani Capital LMS login :" + LANno + e.Message, this);
            }
            return reportsModel;
        }
        public ReportsModel LMSGenerateInterestCertificate(string LANno)
        {
            ...
            try
            {
                Log.Info("Start service Method - LMSInterestCertificate Adani Capital LMS login :" + LANno, this);
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    AccessToken = jServiceResponse.Value<string>("access_token");
                    request.AddHeader("access_token", AccessToken);
                    Log.Info("Received Token for LMSInterestCertificate Adani Capital LMS login :" + AccessToken, this);
                }
 ...
 " + "\n" +
                ...
                if (response.IsSuccessful)
                {
                    Log.Info("Received Data Success for LMSInterestCertificate Adani Capital LMS login :" + response.Content, this);
                    var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                    ...
                    {
                        Log.Info("Received Data Error for LMSInterestCertificate Adani Capital LMS login :" + response.Content, this);
                        reportsModel.Message = DictionaryPhraseRepository.Current.Get("/Controller/Messages/NoUserFound", LANno + " is not valid");
                        reportsModel.IsRequestValid = false;
                    }
                }
                ...
                {
                    Log.Info("Service Response not successfull for LMSInterestCertificate Adani Capital LMS login :" + response.Content, this);
                    reportsModel.IsRequestValid = false;
                }
            }
            catch (Exception e)
            {
                Log.Error("Error in Method - LMSInterestCertificate Adani Capital LMS login :" + LANno + e.Message, this);
            }
            return reportsModel;
        }
        public ReportsModel LMSGetBalnaceConfirmLetter(string LANno)
        {
            ...
            try
            {
                Log.Info("Start service Method - LMSGetBalnaceConfirmLetter Adani Capital LMS login :" + LANno, this);
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    AccessToken = jServiceResponse.Value<string>("access_token");
                    request.AddHeader("access_token", AccessToken);
                    Log.Info("Received Token for LMSGetBalnaceConfirmLetter Adani Capital LMS login :" + AccessToken, this);
                }
 ...
 " + "\n" +
                ...
                if (response.IsSuccessful)
                {
                    Log.Info("Received Data Success for LMSGetBalnaceConfirmLetter Adani Capital LMS login :" + response.Content, this);
                    var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                    ...
                    {
                        Log.Info("Received Data Error for LMSGetBalnaceConfirmLetter Adani Capital LMS login :" + response.Content, this);
                        reportsModel.Message = DictionaryPhraseRepository.Current.Get("/Controller/Messages/NoUserFound", LANno + " is not valid");
                        reportsModel.IsRequestValid = false;
                    }
                }
                ...
                {
                    Log.Info("Service Response not successfull for LMSGetBalnaceConfirmLetter Adani Capital LMS login :" + response.Content, this);
                    reportsModel.IsRequestValid = false;
                }
            }
            catch (Exception e)
            {
                Log.Error("Error in Method - LMSGetBalnaceConfirmLetter Adani Capital LMS login :" + LANno + e.Message, this);
            }
            return reportsModel;
        }
        public ReportsModel LMSGetWelcomeLetter(string LANno)
        {
            ...
            try
            {
                Log.Info("Start service Method - LMSGetWelcomeLetter Adani Capital LMS login :" + LANno, this);
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    AccessToken = jServiceResponse.Value<string>("access_token");
                    request.AddHeader("access_token", AccessToken);
                    Log.Info("Received Token for LMSGetWelcomeLetter Adani Capital LMS login :" + AccessToken, this);
                }
 ...
 " + "\n" +
                ...
                if (response.IsSuccessful)
                {
                    Log.Info("Received Data Success for LMSGetWelcomeLetter Adani Capital LMS login :" + response.Content, this);
                    var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                    ...
                    {
                        Log.Info("Received Data Error for LMSGetWelcomeLetter Adani Capital LMS login :" + response.Content, this);
                        reportsModel.Message = DictionaryPhraseRepository.Current.Get("/Controller/Messages/NoUserFound", LANno + " is not valid");
                        reportsModel.IsRequestValid = false;
                    }
                }
                ...
                {
                    Log.Info("Service Response not successfull for LMSGetWelcomeLetter Adani Capital LMS login :" + response.Content, this);
                    reportsModel.IsRequestValid = false;
                }
            }
            catch (Exception e)
            {
                Log.Error("Error in Method - LMSGetWelcomeLetter Adani Capital LMS login :" + LANno + e.Message, this);
            }
            return reportsModel;
        }
        public ReportsModel LMSGenerateRepaymentSchedule(string LANno)
        {
            ...
            try
            {
                Log.Info("Start service Method - LMSGenerateRepaymentSchedule Adani Capital LMS login :" + LANno, this);
                ...
                if (!string.IsNullOrEmpty(LMSServiceResponse))
                {
                    ...
                    AccessToken = jServiceResponse.Value<string>("access_token");
                    request.AddHeader("access_token", AccessToken);
                    Log.Info("Received Token for LMSGenerateRepaymentSchedule Adani Capital LMS login :" + AccessToken, this);
                }
 ...
 " + "\n" +
                ...
                if (response.IsSuccessful)
                {
                    Log.Info("Received Data Success for LMSGenerateRepaymentSchedule Adani Capital LMS login :" + response.Content, this);
                    var responseObj = JsonConvert.DeserializeObject<dynamic>(response.Content);
                    ...
                    {
                        Log.Info("Received Data Error for LMSGenerateRepaymentSchedule Adani Capital LMS login :" + response.Content, this);
                        reportsModel.Message = DictionaryPhraseRepository.Current.Get("/Controller/Messages/NoUserFound", LANno + " is not valid");
                        reportsModel.IsRequestValid = false;
                    }
                }
                ...
                {
                    Log.Info("Service Response not successfull for LMSGenerateRepaymentSchedule Adani Capital LMS login :" + response.Content, this);
                    reportsModel.IsRequestValid = false;
                }
            }
            catch (Exception e)
            {
                Log.Error("Error in Method - LMSGenerateRepaymentSchedule Adani Capital LMS login :" + LANno + e.Message, this);
            }
            return reportsModel;
        }
        public TransactionsModel LMSGet_Transactions(TransactionsModel transactionsModel)
        {
            try
            {
                Log.Info(string.Concat("Start service Method - LMSGet_Transactions Adani Capital LMS login :", transactionsModel.LoanAccountNumber), this);
                ...
                if (!string.IsNullOrEmpty(str1))
                {
                    ...
                    Log.Info(string.Concat("Received Token for LMSGet_Transactions Adani Capital LMS login :", str2), this);
                }
                ...
                {
                    Log.Info(string.Concat("Service Response not successfull for LMSGet_Transactions Adani Capital LMS login :", restResponse.Content), this);
                ...
                {
                    Log.Info(string.Concat("Received Data Success for LMSGet_Transactions Adani Capital LMS login :", restResponse.Content), this);
                    dynamic obj = JsonConvert.DeserializeObject<object>(restResponse.Content);
                    if (obj["success"] == null)
                    {
                        Log.Info(string.Concat("Received Data Error for LMSGet_Transactions Adani Capital LMS login :", restResponse.Content), this);
            ...
            catch (Exception exception1)
            {
                ...
                Log.Error(string.Concat("Error in Method - LMSGet_Transactions Adani Capital LMS login :", transactionsModel.LoanAccountNumber, exception.Message), this);
                transactionsModel.Message = DictionaryPhraseRepository.Current.Get("/Controller/Messages/get transaction error", "Error in getting transactions");
            }
        ...
        public OTPModel SendOTP(string MobileNo, string pageInfo)
        {
            ...
            try
            {
                ...
                Log.Info(string.Concat("Method - Store Adani Capital StoreOTP in Database :", otpModel.MobileNo), this);
                using (AdaniCapitalFormsDataContext adaniCapitalFormsDataContext = new AdaniCapitalFormsDataContext())
                {
                    AdaniCapitalOTP adaniCapitalOTP = (
                    ...
                    if (adaniCapitalOTP != null)
                    {
                        if (Int64.Parse(adaniCapitalOTP.Count) < 3)
                        {
                            flag = false;
                        }
                        else
                        {
                            DateTime value = adaniCapitalOTP.DateTime.Value;
                            flag = value.AddMinutes(10) > DateTime.Now;
                        }
                        if (!flag)
                        {
                            otpModel.Count = adaniCapitalOTP.Count;
                            if (adaniCapitalOTP.DateTime.Value.AddMinutes(10) <= DateTime.Now)
                            {
                                otpModel.Count = "0";
                            }
                        }
                ...
                otpModel.PageInfo = pageInfo ?? "adaniCapital";
            ...
            {
                Exception exception = exception1;
                Log.Error(string.Concat("SendOTP exception: ", exception.Message), "Adani Capital SendOTP");
                otpModel = null;
            }
            return otpModel;
        }
        public OTPModel ValidateOTP(string MobileNo, string otp, string pageInfo)
        {
            ...
            try
            {
                Log.Info(string.Concat("Method - Store Adani Capital ValidateOTP in Database :", MobileNo), this);
                using (AdaniCapitalFormsDataContext adaniCapitalFormsDataContext = new AdaniCapitalFormsDataContext())
                {
                    AdaniCapitalOTP adaniCapitalOTP = (
                        from x in adaniCapitalFormsDataContext.AdaniCapitalOTPs
                    ...
                    if (adaniCapitalOTP != null)
                    {
                        if (string.IsNullOrEmpty(adaniCapitalOTP.ValidateOTPCount))
                        {
                            adaniCapitalOTP.ValidateOTPCount = "1";
                            adaniCapitalFormsDataContext.SubmitChanges();
                        }
                        else
                        {
                            if (Int64.Parse(adaniCapitalOTP.ValidateOTPCount) <= 3)
                            {
                                int num = int.Parse(adaniCapitalOTP.ValidateOTPCount) + 1;
                                adaniCapitalOTP.ValidateOTPCount = num.ToString();
                                adaniCapitalFormsDataContext.SubmitChanges();
                            }
                            else
                            {
            ...
            {
                Exception exception = exception1;
                Log.Error(string.Concat("ValidateOTP exception: ", exception.Message), "Adani Capital ValidateOTP");
                model.IsOTPvalid = false;
            }
            return model;
        }
        ...
        public string GetIPAddress()
        {
            ...
            {
                Log.Error("GetIPAddress exception: " + e.Message, "Adani Capital GetIPAddress");
                return null;
            }
        }
        ...
        public bool StoreCurrentSession()
        {
            ...
            {
                Log.Error("Session store failed for adani Capital login: " + e.Message, this);
                return false;
            }
        }
        ...
        public string GetLastLoginDateTime()
        {
            ...
            {
                Log.Error("failed for adani Capital GetLastLoginDateTime: " + e.Message, this);
                return string.Empty;
            }
        }
    }
