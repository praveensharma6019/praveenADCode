...
namespace Sitecore.AdaniCapital.Website.Models
{
    public class FreshdeskCreateTicketModel
    {
        ...
        public static string InvalidEmailAddress
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniCapital/AfterLoginSupportForm/Invalid Email Address", "Please enter a valid email address");
            }
        }
        public static string InvalidMobile
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniCapital/AfterLoginSupportForm/Invalid Mobile", "Please enter a valid Mobile Number");
            }
        }
        public static string InvalidName
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniCapital/AfterLoginSupportForm/Invalid Name", "Please enter a valid Name");
            }
        }
        public static string InvalidLAN
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniCapital/AfterLoginSupportForm/Invalid LAN", "Please enter a valid LoanAccountNumber");
            }
        }
        public static string InvalidSubject
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniCapital/AfterLoginSupportForm/Invalid Subject", "Please select a Subject");
            }
        }
        public static string Required
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniCapital/AfterLoginSupportForm/Required", "Please enter value for {0}");
            }
        }
