namespace Sitecore.AdaniCapital.Website.Attributes
{
    ...
    public class RedirectUnAuthenticatedAdaniCapitalAttribute : ActionFilterAttribute
    {
        private readonly IGetRedirectUrlService getRedirectUrlService;

        public RedirectUnAuthenticatedAdaniCapitalAttribute() : this(ServiceLocator.ServiceProvider.GetService<IGetRedirectUrlService>())
        {
        }

        public RedirectUnAuthenticatedAdaniCapitalAttribute(IGetRedirectUrlService getRedirectUrlService)
        {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            //string loginType = WebAPIAdaniGas.LoginModuleType(System.Web.HttpContext.Current.Request.Url.AbsolutePath.ToLower());
            AdaniCapitalWebAPIServices webAPIServices = new AdaniCapitalWebAPIServices();
