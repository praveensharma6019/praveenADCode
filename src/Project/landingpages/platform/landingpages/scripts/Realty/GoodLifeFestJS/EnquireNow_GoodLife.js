...
function getCaptchaResponseForm(e) {
    grecaptcha.ready(function () {
        grecaptcha.execute('6Le0pu0gAAAAAD9pAHmh_CiRwBo6VZCNEvhMMnes', { action: 'GoodLifeEnquiryNow' }).then(function (token) {
            ...
            $.ajax({
                ...
                url: "/api/Realty/GoodLifeEnquiryNow",
                contentType: "application/json",
                success: function (data) {
                    if (data.status === "101") {

                        $(this).prop('disabled', true);
                        window.location.href = "/GoodLifeFest/thankyou";
                ...
                success: function (data) {
                    if (data.status === "101") {
                        ...
                        if (userAgent.match(/iPad/i) || userAgent.match(/iPhone/i) || userAgent.match(/iPod/i)) {
                            ...
                            if (val == 'Amogha') {
                                var link = document.createElement('a');
                                link.href = "-/media-archive/Amogha Brochure.pdf";
                                link.download = "Amogha Brochure.pdf";
                                link.click();
                                link.remove();
                            }
                            if (val == 'Aster') {
                                var link = document.createElement('a');
                                link.href = "-/media-archive/Aster Brochure.pdf";
                                link.download = "Aster Brochure.pdf";
                                link.click();
                                link.remove();
                            }
                        }
