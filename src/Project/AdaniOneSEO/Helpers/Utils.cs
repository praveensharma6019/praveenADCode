...
namespace Project.AdaniOneSEO.Website.Helpers
{
    public static class Utils
    {
        ...
        public static int GetIntValue(Item item, ID fieldId, int defaultValue = 0)
        {
            string fieldValue = item.Fields[fieldId]?.Value;
            return string.IsNullOrEmpty(fieldValue) ? defaultValue : System.Convert.ToInt32(fieldValue);
        }
