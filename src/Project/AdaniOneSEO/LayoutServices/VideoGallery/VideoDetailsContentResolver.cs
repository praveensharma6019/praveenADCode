...
{
    public class VideoDetailsContentResolver : RenderingContentsResolver
    {
        private readonly IVideoGalleryService _videoGalleryService;

        public VideoDetailsContentResolver(IVideoGalleryService videoGalleryService)
        {
        ...
        {
            return _videoGalleryService.GetVideoDetailsPageModel(rendering);
        }
    }
}