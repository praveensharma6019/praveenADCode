...
namespace Sitecore.BelvedereClubAhmedabad.Website.Services
{
    public class ClubAhmedabadRepository
    {
        ...
        public string StoreGeneratedOtp(AvailabilityFormModel model)
        {
