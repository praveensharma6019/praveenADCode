$(document).ready(function () {
    ...
    $(function () {
        $('#datetimepicker_TenderFeeDateOfPayment').datepicker(
            { format: 'dd/mm/yyyy', maxDate: new Date, minDate: new Date(2015, 1, 1) });
        $('#datetimepicker_TenderFeeDateOfPayment').val('');
    });

    $(function () {
        $('#datetimepicker_EMDDateOfPayment').datepicker(
            { format: 'dd/mm/yyyy', maxDate: new Date, minDate: new Date(2015, 1, 1) });
        $('#datetimepicker_EMDDateOfPayment').val('');
    });
