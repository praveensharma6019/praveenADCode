...
namespace Sitecore.ElectricityNew.Website.Model
{
    ...
    public class Tender
    {
        ...
        [RegularExpression("^[a-zA-Z0-9][a-zA-Z0-9. -]*$", ErrorMessageResourceName = nameof(InvalidBankBranchName), ErrorMessageResourceType = typeof(Tender))]
        ...
        [Required(ErrorMessageResourceName = nameof(Required), ErrorMessageResourceType = typeof(Tender))]
        [RegularExpression("^[a-zA-Z0-9][a-zA-Z0-9. -]*$", ErrorMessageResourceName = nameof(InvalidBankRefName), ErrorMessageResourceType = typeof(Tender))]
        ...
        [Required(ErrorMessageResourceName = nameof(SelectDropdown), ErrorMessageResourceType = typeof(Tender))]
        ...
        public static string SelectDropdown => DictionaryPhraseRepository.Current.Get("/Accounts/Model Messages/Required Select", "Please select a value for {0}");
