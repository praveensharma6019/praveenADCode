...
{
    /// <summary>
    /// Summary description for clsEncryptAES
    /// </summary>
    public class clsEncryptAES
    {
        public clsEncryptAES()
        {
            //
        ...
        public clsEncryptAES(string keyPassword)
        {
            password = keyPassword;
        }

        //string password = "@Aeml#2020";
        ...
        {
            clsEncryptAES objaes = new clsEncryptAES();
            ...
            baEncrypted = objaes.AES_Encrypt(baEncrypted, baPwdHash);

            string result = System.Convert.ToBase64String(baEncrypted);
            return result;
        }
        ...
        public string DecryptString(string text)
        {
            ...
            byte[] baText = System.Convert.FromBase64String(text);

            byte[] baDecrypted = objaes.AES_Decrypt(baText, baPwdHash);
