<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentData.aspx.cs" Inherits="Sitecore.ElectricityNew.Website.sitecore.admin.Electricity.PaymentData" %>
            ...
            <div class="pageContent">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <br>
                            <h4 class="float-left"><span class="txt-orange">Download Payment Transaction History</span></h4>
                        ...
                        <div class="col-md-12 col-lg-12" id="mainContent">
                            ...
                            <div class="panel">
                                <form id="form1" class="pt-3" runat="server">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <label for="" class="col-sm-4 col-md-6 col-form-label">Payment mode</label>
                                            <div class="col-sm-12 col-lg-12">
                                                <asp:DropDownList ID="drpPaymentGateway" runat="server" class="form-control" AutoPostBack="True">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="" class="col-sm-4 col-md-6 col-form-label">Payment gateway</label>
                                            <div class="col-sm-12 col-lg-12">

                                                <asp:DropDownList ID="drpPaymentType" runat="server" class="form-control" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <label for="" class="col-sm-4 col-md-6 col-form-label">Status</label>
                                            <div class="col-sm-12 col-lg-12">
                                                <asp:DropDownList ID="drpStatus" runat="server" class="form-control" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
