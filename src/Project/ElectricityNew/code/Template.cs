...
namespace Sitecore.ElectricityNew.Website
{
    public class Template
    {
        public struct Tender
        {
            ...
            public static readonly ID TenderRegistration = new ID("{12705B01-75A4-4C50-8BC9-5563393B25D0}"); // not found any where
            public static readonly ID TenderLogin = new ID("{B04FAD05-DAB4-4D6D-8D8D-D213FC986319}");
            public static readonly ID TenderList = new ID("{4E4ABFBF-A16D-43EF-AB25-9CC211A3C87A}");
        }
        ...
        public struct MailTemplate
        {
            ...
            public static readonly ID TenderSubmission = new ID("{640122B9-79D0-4AE7-9B32-EE1CE07710FF}");
