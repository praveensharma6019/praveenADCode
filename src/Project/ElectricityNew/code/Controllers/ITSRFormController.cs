...
namespace Sitecore.ElectricityNew.Website.Controllers
{
    ...
    public class ITSRFormController : Controller
    {
        ...
        public ActionResult ITSRFormEdit()
        {
            ...
            try
            {
                ...
                model = new ITSRFormCreateModel
                {
                    ...
                    StartDate = formdetails.StartDate.ToString(),
                    EndDate = formdetails.EndDate.ToString(),
        ...
        [ValidateRenderingId]
        [ValidateAntiForgeryToken]
        public ActionResult BidderProcessForm(ITSRBidderProcessFormModel model, string GetExistingForm = null, string GetOTP = null, string ValidateOTP = null, string Submit = null, string SaveAsDraft = null, string GetOTPForExistingForm = null, string ValidateOTPForExistingForm = null)
        {
            ITSRBidderFormService objService = new ITSRBidderFormService();
            model.IsExists = true;
        ...
        {
            if (Session["ITSRUserLogin"] == null || ITSRUserSession.ITSRUserSessionContext.UserRole != "SuperAdmin")
            {
                var item = Context.Database.GetItem(Templates.ITSR.ITSRLogin);
                return this.Redirect(item.Url());
            }
