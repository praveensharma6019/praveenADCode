<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShantigramFormMeet.aspx.cs" Inherits="Sitecore.SportsLine.Website.sitecore.admin.SportsLine.ShantigramFormMeet" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 mx-auto vertical-middle">
                <p class="txt-center">
                    <img src="/images/SportsLine/logo.png" alt="Adani SportsLine" disablewebedit="False">
                </p>
