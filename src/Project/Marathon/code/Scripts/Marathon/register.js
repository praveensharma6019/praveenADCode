...
$('input[type=radio][name=runMode]').change(function () {
    ...
    if (idVal === "Physical") {
        ...
        $('#select_distance').append('<option class="all-dist " value="42.195KM">42.195 Km Run (â‚¹                               2500.00)</option>');
        $('#select_distance').append('<option class="all-dist " value="21.097KM">21.097 Km Run (â‚¹                                2000.00)</option>');
        $('#select_distance').append('<option class="all-dist " value="10KM">10 Km Run (â‚¹                             1750.00)</option>');
        $('#select_distance').append('<option class="all-dist " value="5KM">5 Km Run (â‚¹                                1250.00)</option>');
        ...
        $('#select_distance').text('');
        $('#select_distance').append('<option value="">Select your distance 1</option>');
        $('#select_distance').append('<option class="all-dist " value="42.195KM">42.195 Km Run (â‚¹                                499.00)</option>');
        $('#select_distance').append('<option class="all-dist " value="21.097KM">21.097 Km Run (â‚¹                                499.00)</option>');
        $('#select_distance').append('<option class="all-dist " value="10KM">10 Km Run (â‚¹                              499.00)</option>');
        $('#select_distance').append('<option class="all-dist " value="5KM">5 Km Run (â‚¹                               499.00)</option>');
        //$(".all-dist").css("display", "none");
...
$("#RunmodeListNew").change(function () {
    ...
    if (idVal === "Physical Run") {
        ...
        $('#select_distancenew').append('<option class="all-dist " value="42.195KM">42.195 Km Run (â‚¹                               2500.00)</option>');
        $('#select_distancenew').append('<option class="all-dist " value="21.097KM">21.097 Km Run (â‚¹                                2000.00)</option>');
        $('#select_distancenew').append('<option class="all-dist " value="10KM">10 Km Run (â‚¹                            1750.00)</option>');
        $('#select_distancenew').append('<option class="all-dist " value="5KM">5 Km Run (â‚¹                                1250.00)</option>');
        ...
        $('#select_distancenew').append('<option class="all-dist " value="42.195KM">42.195 Km Run (â‚¹                                499.00)</option>');
        $('#select_distancenew').append('<option class="all-dist " value="21.097KM">21.097 Km Run (â‚¹                                499.00)</option>');
        $('#select_distancenew').append('<option class="all-dist " value="10KM">10 Km Run (â‚¹                              499.00)</option>');
        $('#select_distancenew').append('<option class="all-dist " value="5KM">5 Km Run (â‚¹                               499.00)</option>');
        $("#select_distancenew").val("");
    }
    else {
...
function rundetailscheck() {
	...
	if($('input[name="EmployeeEmailId"]').length!=0)
	{
...
function personalcheck() {
    ...
    var gender_list = $("#registration_form #gender_list").val();
    if (gender_list === "") {
		$("#registration_form #gender_list").next('span').remove();
        $("#registration_form #gender_list").after("<span class='errormsg'>Please select your gender</span>");
        flag++;
    }
            ...
            success: function (data) {
                ...
                if (data.status == "1") {
					...
					for(var i=0; i<$('#select_distance').children().length;i++)
					{
						...
						{
							if(String($('#select_distance option')[i].value)==$('#select_distance option:selected').val().toString())
							{
							...
							if($('#select_distance option')[i].value!='' && selectCOunt==0)
							{
					...
					if($('#RunType1').parent().hasClass('d-none'))
					{
						$('#RunType1').parent().removeClass('d-none');
					}
					$('#RunType1').click();
                }
                else {
					...
					if(!$('#RunType1').parent().hasClass('d-none'))
					{
						$('#RunType1').parent().addClass('d-none');
					}
...
$('.newregistraionMobile').css('padding-top','5px');
$('.newregistraionMobile').css('margin-bottom','10px');