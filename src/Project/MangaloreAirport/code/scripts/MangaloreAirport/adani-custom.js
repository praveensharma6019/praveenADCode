...
$(document).ready(function () {
    ...
    var date = new Date(); var it = ((date.getMonth() > 8) ? (date.getMonth() + 1) : ('0' + (date.getMonth() + 1))) + '/' + ((date.getDate() > 9) ? date.getDate() : ('0' + date.getDate())) + '/' + date.getFullYear(); 
...
$('span#submit').click(function () {
    ...
    if (confirm("Do you really want to delete this User")) {
        $.ajax({
            type: 'POST',
            data: { id: Id },
            url: "/api/MangaloreAirport/DisableEnvelopeUser",
            success: function (data) {
                location.reload();
...
$('span#submits').click(function () {
    ...
    if (confirm("Do you really want to delete this User")) {
        $.ajax({
            type: 'POST',
            data: { id: Id },
            url: "/api/MangaloreAirport/DisableAdminUser",
            success: function (data) {
                location.reload();
    ...
    $("#DateArrival").on("change", function () {
        ...
        $.ajax({
            ...
            url: "/api/MangaloreAirport/MangaloreFlightDetailsArrivalUpdate",
    ...
    $("#DateDeparture").on("change", function () {
        ...
        $.ajax({
            ...
            url: "/api/MangaloreAirport/MangaloreFlightDetailsUpdateDeparture",
            contentType: "application/json",
            success: function (data) {
...
$("#btnSearch").click(function () {
    ...
    if ($("#txtSearch").val().length > 0 || $("#txtSearch").val() != "") {
        $.ajax({
            ...
            url: "/api/MangaloreAirport/MangaloreFlighSearchDetailsArival",
            contentType: "application/json",
            success: function (data) {
                $('#arrival2').html(data);
            },
...
$("#btnSearchDeparture").click(function () {
    ...
    if ($("#txtSearches").val().length > 0 || $("#txtSearches").val() != "") {
        $.ajax({
            ...
            url: "/api/MangaloreAirport/MangaloreFlighSearchDetailsDeparture",
            contentType: "application/json",
            success: function (data) {
                $('#departure2').html(data);
            },
...
*/
   ...
   // if (TravelDate.setHours(0,0,0,0) < CurrentDate.setHours(0,0,0,0)) { alert("Travel Date should not be past date."); $("#TravelYear").focus(); $('#BtnAPASubmit').removeAttr("disabled"); return false; }
    ...
    $.ajax({
        ...
        url: "/api/MangaloreAirport/BookAirportAssistance",
        contentType: "application/json",
        success: function (data) {
            //////////////

            if (data.status == "1") {
                window.location.href = "https://stage.adaniuat.com/mangaluru-airport/assistance-thankyou";
...
$('.top_bar_nav').click(function(){
  ...
  $("#BtnASFSubmit").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: JSON.stringify(model),
        url: "/api/MangaloreAirport/AirportSurveyFeedback",
        contentType: "application/json",
        success: function (data) {
            //////////////
        ...
        grecaptcha.ready(function() {
          grecaptcha.execute('6LdoDj4hAAAAAD7gqiPJEsAy96GJBkiNRu9qohiz', {action: 'AirportContactUs'}).then(function(token) {
			...
			$.ajax({
					...
					url: "/api/MangaloreAirport/AirportContactUs",
					contentType: "application/json",
					success: function (data) {
						if (data.status == "1") {
							window.location.href = "/mangaluru-airport/thank-you";
						}
