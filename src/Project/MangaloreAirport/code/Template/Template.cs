...
namespace Sitecore.MangaloreAirport.Website.Template
{
    ...
    public struct MailConfiguration
    {
        ...
        {
            public readonly static ID airportSurveyEmailTemplateID = new ID("{A3EBBDDD-02C8-4C44-95A4-68E01F2AFDCA}");
            public readonly static ID AirportContactUsEmailTemplate = new ID("{A6756C0E-C0FB-4A5E-80D0-2B68312B9373}");
