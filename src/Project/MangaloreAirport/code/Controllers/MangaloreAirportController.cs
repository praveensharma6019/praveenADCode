...
using Sitecore.MangaloreAirport.Website.Models;
using Sitecore.MangaloreAirport.Website.Services;
using Sitecore.MangaloreAirport.Website.Utility;
using System;
...
namespace Sitecore.MangaloreAirport.Website.Controllers
{
    public class MangaloreAirportController : Controller
    {
        ...
        TenderDBDataContext mangaloredb = new TenderDBDataContext();
        [HttpGet]
        public ActionResult MangaloreFlightDetails(string ArrivalTime)
        {
            ...
            MangaloreAirportFlightModel mangaloreairportmodel = new MangaloreAirportFlightModel();
            List<MangaloreFlight> MangaloreFlights = new List<MangaloreFlight>();
            Table<MangaloreAirportFlight> MangaloreAirportFlightDetail = this.mangaloredb.MangaloreAirportFlights;
            var StatusList = Sitecore.Context.Database.GetItem("{5BD4D6FD-D1EA-4E73-A007-7496B67E4FDD}");
            IQueryable<MangaloreAirportFlight> MangaloreFlightInformation = MangaloreAirportFlightDetail.Where(val => val.SpecialAction != "Delete" && val.ServiceType == "J" && val.ScheduledTime!=null && val.ScheduledTime.Value.Date == filterdate.Date).OrderBy(val => val.Scheduled);
            
                foreach (MangaloreAirportFlight MangaloreAirportFlightData in MangaloreFlightInformation)
                {

                    DateTime? schDate = MangaloreAirportFlightData.ScheduledTime;
                    ...
                    MangaloreFlight mangaloreflights = new MangaloreFlight()

                    {
                        Scheduled = schTimeFormat,
                        FlightNumber = MangaloreAirportFlightData.FlightNumber.ToString(),
                        ArrivingFrom = MangaloreAirportFlightData.ArrivingFrom.ToString(),
                        DepartureFrom = MangaloreAirportFlightData.DepartureFrom.ToString(),
                        Airline = MangaloreAirportFlightData.Airline,
                        terminal = MangaloreAirportFlightData.Terminal,
                        Flightkind=MangaloreAirportFlightData.flightkind,
                    ...
                    if (StatusList != null)
                    {
                        if (StatusList.HasChildren)
                        {
                            ...
                            {
                                if (MangaloreAirportFlightData.Status == CodeName["CodeValue"])
                                {
                                    var remarkdescription = CodeName["RemarkDescription"];
                                    MangaloreAirportFlightData.Status = remarkdescription;
                                    mangaloreflights.Status = MangaloreAirportFlightData.Status;
                                }
                                else
                                {
                                    mangaloreflights.Status = MangaloreAirportFlightData.Status;
                    ...
                    if (MangaloreAirportFlightData.EstimationTime != null)
                    {
                        DateTime? estimateDate = MangaloreAirportFlightData.EstimationTime;
                        var estimate = estimateDate.Value.ToShortTimeString();
                        var estimateFormat = DateTime.Parse(estimate).ToString("HH:mm");
                        mangaloreflights.EstimationTime = estimateFormat;
                    }

                    MangaloreFlights.Add(mangaloreflights);
                }
            
       
           

            mangaloreairportmodel.MangaloreAirportList = MangaloreFlights;


            return base.View(mangaloreairportmodel.MangaloreAirportList.ToList<MangaloreFlight>());
        }


        [HttpGet]
        public ActionResult MangaloreFlightDetailsArrivalUpdate(string ArrivalTime)
        {
            DateTime filterdate = DateTime.Now;
            var result = new { status = "1" };
            Log.Error("Validating API", "Start");
            ...
            Table<MangaloreAirportFlight> MangaloreAirportFlightDetail = this.mangaloredb.MangaloreAirportFlights;
            var StatusList = Sitecore.Context.Database.GetItem("{5BD4D6FD-D1EA-4E73-A007-7496B67E4FDD}");
            IQueryable<MangaloreAirportFlight> MangaloreFlightInformation = MangaloreAirportFlightDetail.Where(val => val.SpecialAction != "Delete" && val.ServiceType == "J" && val.ScheduledTime != null && val.ScheduledTime.Value.Date == filterdate.Date && val.flightkind== "Arrival").OrderBy(val => val.Scheduled);
            if(MangaloreFlightInformation.Count() >= 1)
            { 
            foreach (MangaloreAirportFlight MangaloreAirportFlightData in MangaloreFlightInformation)
            {
                 DateTime? schDate = MangaloreAirportFlightData.ScheduledTime;
            ...
            return base.View("/views/MangaloreAirport/MangaloreFlightDetailsArrivalUpdate.cshtml", mangaloreairportmodel.MangaloreAirportList.ToList<MangaloreFlight>());
        }

        [HttpGet]
        public ActionResult MangaloreFlightDetailsUpdateDeparture(string DepartureFlight)
        {
            DateTime filterdate = DateTime.Now;
          ...
          var StatusList = Sitecore.Context.Database.GetItem("{5BD4D6FD-D1EA-4E73-A007-7496B67E4FDD}");
            ...
            List<MangaloreFlight> MangaloreFlights = new List<MangaloreFlight>();
            Table<MangaloreAirportFlight> MangaloreAirportFlightDetail = this.mangaloredb.MangaloreAirportFlights;
           IQueryable<MangaloreAirportFlight> MangaloreFlightInformation = MangaloreAirportFlightDetail.Where(val => val.SpecialAction != "Delete" && val.ServiceType == "J" && val.ScheduledTime != null && val.ScheduledTime.Value.Date == filterdate.Date && val.flightkind == "Departure").OrderBy(val => val.Scheduled);
           ...
           if(MangaloreFlightInformation.Count() >= 1)
            ...
            return base.View("/views/MangaloreAirport/MangaloreFlightDetailsUpdateDeparture.cshtml", mangaloreairportmodel.MangaloreAirportList.ToList<MangaloreFlight>());
        }


       [HttpGet]
        public ActionResult MangaloreFlighSearchDetailsArival(string Search,string ArrivalFlights)
        {
            DateTime filterdate = DateTime.Now;
           ...
           var StatusList = Sitecore.Context.Database.GetItem("{5BD4D6FD-D1EA-4E73-A007-7496B67E4FDD}");
            ...
            List<MangaloreFlight> MangaloreFlights = new List<MangaloreFlight>();
            Table<MangaloreAirportFlight> MangaloreAirportFlightDetail = this.mangaloredb.MangaloreAirportFlights;
            IQueryable<MangaloreAirportFlight> MangaloreFlightInformation = MangaloreAirportFlightDetail.Where(val => val.SpecialAction != "Delete" && val.ServiceType == "J" && val.ScheduledTime != null && val.ScheduledTime.Value.Date == filterdate.Date && val.flightkind == "Arrival" && (val.Airline.StartsWith(Search) || val.FlightNumber.StartsWith(Search))).OrderBy(val => val.Scheduled);
            if (MangaloreFlightInformation.Count() >= 1)
            { 
                foreach (MangaloreAirportFlight MangaloreAirportFlightData in MangaloreFlightInformation)
            {
        ...
        [HttpGet]
        public ActionResult MangaloreFlighSearchDetailsDeparture(string Search,string DepartureFlights)
        {
            DateTime filterdate = DateTime.Now;
        ...
        public ActionResult FLIGHTS()
        {
            ...
            clsEncryptAES objcrypt = new clsEncryptAES("@IxeAdaniAirport");

            string userName_ = objcrypt.EncryptText("IXEAirport");
            string Password_ = objcrypt.EncryptText("IXE@AdaniAirport");
            ...
            if (username != "IXEAirport" || password != "IXE@AdaniAirport")
            {
                result = new { status = "3" };
                return Json(result, JsonRequestBehavior.AllowGet);
            }
                ...
                if (OBJ != null)
                {
                    ...
                    try
                    {
                        ...
                        using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                        {
                            ...
                            //if (dbcontext.MangaloreAirportFlights.Where(t => t.Airline == Airline && t.FlightNumber.ToString() == fligthNumber).Any())
                            if (dbcontext.MangaloreAirportFlights.Where(t => t.OriginDate.Value == DateTime.Parse(Schedule.Value.Date.ToString()) && t.FlightNumber.ToString() == fligthNumber && t.Airline.ToString() == Airline).Any())
                            {

                                //MangaloreAirportFlight flight = dbcontext.MangaloreAirportFlights.Where(t => t.Airline  == Airline && t.FlightNumber.ToString() == fligthNumber).FirstOrDefault();
                                MangaloreAirportFlight flight = dbcontext.MangaloreAirportFlights.Where(t => t.OriginDate.Value == DateTime.Parse(Schedule.Value.Date.ToString()) && t.FlightNumber.ToString() == fligthNumber && t.Airline.ToString() == Airline).FirstOrDefault();
                            ...
                            {
                                MangaloreAirportFlight r1 = new MangaloreAirportFlight();
                                ...
                                #region Insert to DB
                                ////
                                dbcontext.MangaloreAirportFlights.InsertOnSubmit(r1);
                                // rdb.SubmitChanges();
                                try
                                {
                                    dbcontext.SubmitChanges();
        ...
        public ActionResult InsertContact(AdaniAirportsContactUsForm m)
        {
            ...
            if (validationStatus == true)
            {
                ...
                try
                {
                    ...
                    AdaniAirportsContactForm r1 = new AdaniAirportsContactForm();
                    ...
                    #region Insert to DB
                    rdb.AdaniAirportsContactForms.InsertOnSubmit(r1);
                    rdb.SubmitChanges();
                    //  Session["validate"] = Request.Cookies["SIDCC"].Value;
                }
                catch (Exception ex)
                ...
                try
                {
                    var msgTpye = Sitecore.Context.Database.GetItem("{0EA1DD88-DBB0-45A3-A87D-5E1440DBE1EF}");
        ...
        [HttpPost]
        public ActionResult BookAirportAssistance(BookAirportAssistance m)
        {
            ...
            if (validationStatus == true)
            {
                ...
                /*try
                {
                    ...
                    {
                        if (objcontext.AirportAssistances.Where(x => x.ContactNumber.ToString() == m.ContactNumber.ToString()).Any())
                        {
                            result = new { status = "3" };
                            return Json(result, JsonRequestBehavior.AllowGet);
                        }
                ...
                */
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                    TenderDBDataContext rdb = new TenderDBDataContext();
                   AirportAssistance r1 = new AirportAssistance();
                    ...
                    r1.FormSubmitDate = DateTime.Now.ToString();
                        ...
                        #region Insert to DB
                        rdb.AirportAssistances.InsertOnSubmit(r1);
                    rdb.SubmitChanges();
                    //  Session["validate"] = Request.Cookies["SIDCC"].Value;
                    }
                    catch (Exception ex)
        ...
        private void SendMeetandGreetEmail_Adani(BookAirportAssistance m)
        {
            var getEmailTo = "";
            MailMessage mail = null;
            try
            {
                var msgTpye = Sitecore.Context.Database.GetItem("{288F57FD-6167-477C-BD42-84921EFF14F8}");
                getEmailTo = msgTpye.Fields["EmailTo"].Value;


                var settingsItem = Context.Database.GetItem("{3B6BA4D5-5184-43FE-8131-F8C4CFA59B19}");
        ...
        private void SendMeetandGreetEmail_customer(BookAirportAssistance m)
        {
            var getEmailTo = "";
            MailMessage mail = null;
            try
            {
                ...
                var settingsItem = Context.Database.GetItem("{4934B0BD-C60A-4F2A-9B71-AD0D8D39EC18}");
                var mailTemplateItem = settingsItem;
                var fromMail = mailTemplateItem.Fields[Templates.MailTemplate.Fields.From];
        ...
        private void SendMeetandGreetSMS(BookAirportAssistance m)
        {
        ...
        public ActionResult TenderListing()
        {
            ...
            using (TenderDBDataContext dbcontext = new TenderDBDataContext())
            {
                List<TenderList> tenderdata;
                if(!string.IsNullOrEmpty(TenderType))
                        tenderdata = dbcontext.TenderLists.Where(x=>x.TenderType == TenderType).ToList();
                else
                    tenderdata = dbcontext.TenderLists.ToList();
        ...
        public ActionResult UserRegistration(UserDetails model)
        {
            ...
            {
                listPage = Sitecore.Context.Database.GetItem("{90087990-D7FC-45EB-A2E2-5CAB8850C4A3}");
            }
            //var listPage = Sitecore.Context.Database.GetItem(Templates.Tender.TenderList);
            ...
            if (validationStatus)
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        ...
                        using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                        {
                            var user = dbcontext.Registrations.Where(x => x.UniqueId == model.UniqueId && x.TenderId == model.TenderID ).FirstOrDefault();
                            if (user == null)
                            {
                        ...
                        if (TempData["Error"] == null)
                        {
                            ...
                            if (tenderLoginitem != null)
                            {
                                ...
                                {
                                    var baseU = Sitecore.Context.Database.GetItem("{C2171BE7-742F-4853-8E22-AF34E39DC402}").Name;
        ...
        public ActionResult TenderLogin(Login model)
        {
            ...
            else
            {
                try
                {
                    ...
                    using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                    {
                        ...
                        if (registerUser != null && registerUser.UserType != "SuperAdmin" && registerUser.UserType != "Admin")
                        {
                            ...
                            {
                                ModelState.AddModelError(nameof(model.Password), DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Login tender Error", "This Tender is closed, you won't be able to login now."));
                                return this.View(model);
                            }
                            else if (registerUser.UserType.ToLower() == "visitor" && registerUser.AllowLogin == false)
                            {
                                ModelState.AddModelError(nameof(model.Password), DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Login tender Error", "You won't be able to login now."));
                                return this.View(model);
                            }
                        }
                        ...
                        {
                            var loginhistories = dbcontext.LoginHistories.Where(x => x.Userid == model.LoginName && x.CreatedDate.GetValueOrDefault().Date == DateTime.Now.Date).Count();
                            if (loginhistories <= 5)
                            {
                                ...
                                dbcontext.LoginHistories.InsertOnSubmit(entity);
                                dbcontext.SubmitChanges();
                            }
                            else
                            {
                            ...
                            ModelState.AddModelError(nameof(model.Password), DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Login User Error", "User and password is not valid. Please enter valid credential."));
                            return this.View(model);
                        }
                ...
                catch (System.Exception ex)
                {
                    ...
                    ModelState.AddModelError(nameof(model.Password), DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Login Technical Error", "There is technical problem. Please try after sometime."));
                    return this.View(model);
                }
            }
        }
        ...
        private string IsUploadingInSequesnce(string envelopeType, string userid)
        {
            using (TenderDBDataContext dbcontext = new TenderDBDataContext())
            {
                ...
                {
                    if (!dbcontext.UserTenderDocuments.Any(x => x.UserId == userid && x.EnvelopeType == "1") || !dbcontext.UserTenderDocuments.Any(x => x.UserId == userid && x.EnvelopeType == "2"))
                    {
        ...
        public FileResult DownloadUserFile(Guid id)
        {
            ...
            using (TenderDBDataContext dbcontext = new TenderDBDataContext())
            {
                var fileToDownload = dbcontext.UserTenderDocuments.Where(i => i.Id == id).FirstOrDefault();
        ...
        public FileResult DownloadFile(Guid id)
        {
            ...
            using (TenderDBDataContext dbcontext = new TenderDBDataContext())
            {
                var fileToDownload = dbcontext.TenderDocuments.Where(i => i.Id == id).FirstOrDefault();
                return File(fileToDownload.DocData.ToArray(), fileToDownload.ContentType, fileToDownload.FileName);
            }
        }
        ...
        public FileResult DownloadCorrigendumFile(Guid id)
        {
            ...
            using (TenderDBDataContext dbcontext = new TenderDBDataContext())
            {
                var fileToDownload = dbcontext.CorrigendumDocuments.Where(i => i.Id == id).FirstOrDefault();
                return File(fileToDownload.DocData.ToArray(), fileToDownload.ContentType, fileToDownload.FileName);
            }
        }
            ...
            try
            {
                ...
                if (TenderUserSession.TenderUserSessionContext != null && !string.IsNullOrEmpty(TenderUserSession.TenderUserSessionContext.TenderId))
                {
                    ...
                    using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                    {
                        ...
                        Tender.tenderdocument = tenderdetails.TenderDocuments.Where(t => t.IsPQDoc != true).ToList();
                        Tender.tenderPQdocument = tenderdetails.TenderDocuments.Where(t => t.IsPQDoc == true).ToList();
                ...
                if (!string.IsNullOrEmpty(uploadDoc) || !string.IsNullOrEmpty(saveDoc))
                {
                    if (Model != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(uploadDoc))
                        {
                            using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                            {
                                var user = dbcontext.Registrations.Where(x => x.UserId == TenderUserSession.TenderUserSessionContext.userId).FirstOrDefault();
                                if (user != null)
                                {
                                    ...
                                    // List<Registration> UserEmailList = dbcontext.Registrations.Where(x => x.UserType.ToLower() == "admin" || x.UserType.ToLower() == "superadmin" || (x.UserType.ToLower() == "envelopeadmin" && x.TenderId.ToString() == Model.TenderId.ToString())).ToList();
                                    List<Registration> UserEmailList;
                                    ...
                                    { 
                                        UserEmailList = dbcontext.Registrations.Where(x => (x.UserType.ToLower() == "envelopeadmin" && x.TenderId.ToString() == Model.TenderId.ToString())).ToList();
                                    }
                                    else
                                    {
                                        UserEmailList = dbcontext.Registrations.Where(x => x.UserType.ToLower() == "admin" || x.UserType.ToLower() == "superadmin" || (x.UserType.ToLower() == "envelopeadmin" && x.TenderId.ToString() == Model.TenderId.ToString())).ToList();
                                    }
        ...
        public string saveUserTenderFile(HttpPostedFileBase file, string envelopeType, string userid)
        {
            if (file != null && file.ContentLength > 0)
            {
                ...
                using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                {
                    if (dbcontext.UserTenderDocuments.Any(x => x.UserId == userid && x.EnvelopeType == envelopeType && x.FileName == file.FileName))
                    {
        ...
        {
            MangaloreAirportRepository ElecRepo = new MangaloreAirportRepository();
        ...
        public ActionResult AdminTenderListing()
        {
            ...
            try
            {
                ...
                using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                {
                    ...
                    {
                        tenderdata = dbcontext.TenderLists.OrderBy(x => x.Closing_Date).ToList();
                    }
                    else if (UserType == "Admin")
                    {
                        tenderdata = (from tnderlist in dbcontext.TenderLists orderby tnderlist.Closing_Date ascending where tnderlist.CreatedBy == UserId select tnderlist).ToList();
                    }
                    else // Envelope Admin
                    {
                        tenderdata = (from tdruser in dbcontext.UserTenderMappings join tnderlist in dbcontext.TenderLists on tdruser.TenderId equals tnderlist.Id orderby tnderlist.Closing_Date ascending where tdruser.UserId == UserId select tnderlist).ToList();
                    }
        ...
        public ActionResult AdminTenderUserListing()
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["id"]))
                {
                    ...
                    using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                    {
                        datalist = dbcontext.Registrations.Where(x => x.TenderId == tenderId && x.status == true && x.UserType.ToLower() == "visitor").Select(s => new RegistedUserHasDocument
                        {
                            Name = s.Name,
                            ...
                            Mobile = s.Mobile,
                            UserId = s.UserId,
                            Description = s.TenderList.Description,
                            HasDocumentUploaded = dbcontext.UserTenderDocuments.Where(x => x.UserId == s.UserId && (x.IsPQDoc == false || x.EnvelopeType=="2")).Any() ? "Yes" : "No",
                            HasPQDocumentUploaded = dbcontext.UserTenderDocuments.Where(x => x.UserId == s.UserId && (x.IsPQDoc == true || x.EnvelopeType == "2")).Any() ? "Yes" : "No",
                            TenderId = s.TenderList.Id.ToString(),
            ...
            try
            {
                ...
                if (UserType == "EnvelopeAdmin")
                {
                    ...
                    using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                    {
                        ...
                        {
                            var usertoapprove = dbcontext.Registrations.Where(i => i.UserId == uid).FirstOrDefault();
                            if (usertoapprove.PQEnvelopeReviewStatus == false || usertoapprove.PQEnvelopeReviewStatus == null)
                            {
                                ...
                                List<Registration> UserEmailList = dbcontext.Registrations.Where(x => x.UserType.ToLower() == "admin" || x.UserType.ToLower() == "superadmin").ToList();
                ...
                if (adminAproval)
                {
                    using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                    {
                        ...
                        if (tenderLoginitem != null)
                        {
                            ...
                            var subsiteURL = Sitecore.Context.Database.GetItem("{C2171BE7-742F-4853-8E22-AF34E39DC402}").Name;
                        ...
                        try
                        {
                            if (!string.IsNullOrEmpty(RedirectUrl))
                            {
                                var tenderDetails = dbcontext.TenderLists.Where(t => t.Id == tenderid).FirstOrDefault();
                                TenderService Tn = new TenderService();
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["id"]))
                {
                    ...
                    using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                    {
                        datalist = dbcontext.Registrations.Where(x => x.TenderId == tenderId && x.status == true && x.UserType.ToLower() == "visitor").Select(s => new RegistedUserHasDocument
                        {
                            ...
                            UserId = s.UserId,
                            Description = s.TenderList.Description,
                            HasDocumentUploaded = dbcontext.UserTenderDocuments.Where(x => x.UserId == s.UserId).Any() ? "Yes" : "No",
                            TenderId = s.TenderList.Id.ToString()
                        }).ToList();
                        var TenderNITNo = dbcontext.TenderLists.Where(x => x.Id == tenderId).FirstOrDefault().NITNo;
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["id"]) && !string.IsNullOrEmpty(Request.QueryString["uid"]))
                {
                    ...
                    using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                    {
                        ...
                        var userdetails = dbcontext.Registrations.Where(x => x.TenderId == tenderId && x.UserId == tenderuserid).FirstOrDefault();
                        ...
                        tender.userUpladdocument = userdocument;
                        tender.PQApprovalRequired = tenderdetails.PQApprovalRequired == null ? false : tenderdetails.PQApprovalRequired;
                        ViewBag.Envelopetype = UserType == "SuperAdmin" ? "0" : dbcontext.UserTenderMappings.Where(x => x.UserId == UserId && x.TenderId == tenderId).FirstOrDefault().Envelope;
        ...
        public ActionResult AdminTenderCreate(TenderCreateModel obj)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("Adv_Date", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "Please Input Date in dd-MM-yyyy HH:mm:ss format"));
                    ...
                    {
                        ModelState.AddModelError("Closing_Date", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "Please Input Date in dd-MM-yyyy HH:mm:ss format"));
                        return View(ReturnObj(obj));
                    }
                    if (obj.Files.Count() > 0 && obj.PQFiles.Count() > 0)
                    {
                        ...
                        if (obj.Files[0] == null)
                        {
                            ModelState.AddModelError("Files", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "Please upload tender document"));
                            err = true;
                        }
                        if (obj.PQFiles[0] == null && obj.PQApprovalRequired == true)
                        {
                            ModelState.AddModelError("PQFiles", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "Please upload PQ document"));
                            err = true;
                        }
                        if (err)
                        {
                    ...
                    foreach (HttpPostedFileBase file in obj.Files)
                    {
                        if (file != null)
                        {
                            ...
                            if (size > 10240)
                            {
                                ModelState.AddModelError("Files", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "Tender document size can not exceed then 10 MB"));
                                return View(ReturnObj(obj));
                            }
                        }
                    }
                    ...
                    foreach (HttpPostedFileBase file in obj.PQFiles)
                    {
                        if (file != null)
                        {
                            ...
                            if (size > 10000)
                            {
                                ModelState.AddModelError("PQFiles", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "PQ document size can not exceed then 10 MB"));
                                return View(ReturnObj(obj));
                            }
                        }
                    }
                    ...
                    if (string.IsNullOrEmpty(obj.EnvelopUser1email) == false || string.IsNullOrEmpty(obj.EnvelopUser1Mobile) == false || string.IsNullOrEmpty(obj.EnvelopUser1Name) == false ||obj.EnvelopUser1EnvelopNameCheckboxs.Where(x => x.IsChecked == true).Count() > 0)
                    {
                        ...
                        {
                            ModelState.AddModelError("EnvelopUser1Mobile", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "All Fields are mandatory for Envelop user."));
                            return View(ReturnObj(obj));
                        }
                    }
                    if (string.IsNullOrEmpty(obj.EnvelopUser2email) == false || string.IsNullOrEmpty(obj.EnvelopUser2Mobile) == false || string.IsNullOrEmpty(obj.EnvelopUser2Name) == false || obj.EnvelopUser2EnvelopNameCheckboxs.Where(x => x.IsChecked == true).Count() > 0)
                    {
                        ...
                        {
                            ModelState.AddModelError("EnvelopUser2Mobile", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "All Fields are mandatory for Envelop user."));
                            return View(ReturnObj(obj));
                        }
                    }
                    if (string.IsNullOrEmpty(obj.EnvelopUser3email) == false || string.IsNullOrEmpty(obj.EnvelopUser3Mobile) == false || string.IsNullOrEmpty(obj.EnvelopUser3Name) == false)
                    {
                        ...
                        {
                            ModelState.AddModelError("EnvelopUser3Mobile", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "All Fields are mandatory for Envelop user."));
                            return View(ReturnObj(obj));
                        }
                    }
                    if (string.IsNullOrEmpty(obj.EnvelopUser4email) == false || string.IsNullOrEmpty(obj.EnvelopUser4Mobile) == false || string.IsNullOrEmpty(obj.EnvelopUser4Name) == false)
                    {
                        ...
                        {
                            ModelState.AddModelError("EnvelopUser4Mobile", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "All Fields are mandatory for Envelop user."));
                            return View(ReturnObj(obj));
                        }
                    }
                    if (string.IsNullOrEmpty(obj.EnvelopUser5email) == false || string.IsNullOrEmpty(obj.EnvelopUser5Mobile) == false || string.IsNullOrEmpty(obj.EnvelopUser5Name) == false)
                    {
                        ...
                        {
                            ModelState.AddModelError("EnvelopUser5Mobile", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "All Fields are mandatory for Envelop user."));
                            return View(ReturnObj(obj));
                        }
                    }
                    ...
                    if (Envelop1User)
                    {
                        ...
                        using (TenderDBDataContext dbcontext = new TenderDBDataContext())
                        {
                            var tender = dbcontext.TenderLists.Where(x => x.Id == new Guid(EnpObj.SelectTenderId)).FirstOrDefault();
                            if (!string.IsNullOrEmpty(RedirectUrl))
                            {
                                //Note : Send Mail to User 
                                TenderService Tn = new TenderService();
                    ...
                    ViewBag.SuccessMsg = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Tender Successful Message", "Tender Uploaded Successfully");
                    ModelState.Clear();
                    return View(ReturnObj(obj));
            ...
            catch (Exception ex)
            {
                ...
                ViewBag.ErrorMsg = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/AdminTender Exception", "Error in uploading Please try again");
                return View(ReturnObj(obj));
            }
        ...
        public ActionResult AdminTenderUpdate(TenderEditModel obj, string Inactivate_tender = null, string Activate_tender = null)
        {
            ...
            try
            {
                ...
                else if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        ViewBag.Message = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Tender Successful Message", "Tender Uploaded Successfully");
                        return Redirect(listingitem.Url());
                    }
                }
                return View(obj);
            ...
            catch (Exception ex)
            {
                ...
                ViewBag.EditError = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/TenderUpdate Exception", "Error in uploading Please try again");
                return View(obj);
            }
        }
        ...
        public List<TenderDetails> TenderDocFunction(Guid corrigenudmID)
        {
            ...
            {
                List<TenderDetails> list = new List<TenderDetails>();
                var TenderDocList = dbcontext.CorrigendumDocuments.Where(x => x.CorrigendumId == corrigenudmID).Select(x => new TenderDetails() { Id = x.Id, FileName = x.FileName }).ToList();
        ...
        public ActionResult CorrigendumCreate(CorrigendumModel obj)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ViewBag.selectedRecordNull = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Tender Selection Validation", "Please Select Tender for Corrigendum List");
                        return View(obj);
                    }
                    ...
                    {
                        ModelState.AddModelError("Date", DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Date Invalid formate", "Please Input Date in dd-MM-yyyy HH:mm:ss format"));
                        return View(obj);
                    }
                    else
                    {
                    ...
                    ViewBag.SuccessMsg = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Corrigendum Success Msg", "Corrigendum Uploaded Successfully");
                    ModelState.Clear();
                    CorrigendumModel model = new CorrigendumModel();
            ...
            catch (Exception ex)
            {
                ...
                ViewBag.ErrorMsg = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Corrigendum exception msg", "Error in Insert Please try again");
                return View(obj);
            }
        }
        ...
        public ActionResult CorrigenudumUpdate(CorrigedumEditModel obj, string Inactivate_Corrigendum = null, string Activate_Corrigendum = null)
        {
            ...
            try
            {
                ...
                else if (ModelState.IsValid)
                {
                    ...
                    {
                        ViewBag.selectedRecordNull = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Tender Selection Validation", "Please Select Tender List");
                        return View(obj);
                    }
                    else
                    {
            ...
            catch (Exception ex)
            {
                ...
                ViewBag.EditError = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Corrigendum exception msg", "Error in Insert Please try again");
                return View(obj);
            }
        }
            ...
            if (validationStatus)
            {
                ...
                try
                {
                    if (ModelState.IsValid)
                    {
                        ...
                        {
                            ViewBag.SelectTenderId = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Selection Validation msg", "Please Select Tender From List");
                            return View(ReturnObj);
                        }
                        if (SelectedEnvelope.Count <= 0)
                        {
                            ViewBag.SelectedEnvelope = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/Envelop selection msg", "Please Select Minimum 1 Envelope");
                            return View(ReturnObj);
                        }
                        ...
                        ViewBag.SuccessMsg = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/EnvelopUser Success Msg", "User created successfully and an email has been sent with details.");
                        ModelState.Clear();
                        return View(ReturnObj);
                    }
                    else
                ...
                catch (Exception ex)
                {
                    ...
                    ViewBag.ErrorMsg = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/EnvelopUser Exception Msg", "Error in Insert Please try again");
                    return View(ReturnObj);
                }
            }
            else {
        ...
        public ActionResult DisableEnvelopeUser(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                ViewBag.DisableUserError = DictionaryPhraseRepository.Current.Get("/MangaloreAirport/Tender/DisableEnvelopeUser Exception Msg", "There is Error in Disable Users");
                return View();
            }
        ...
        [HttpPost]
        public ActionResult InsertJSON(string jsonFile)
        {
            ...
            try
            {
                dynamic OBJ = JsonConvert.DeserializeObject<Object>(jsonFile);
       ...
       [HttpPost]
        ...
        public ActionResult AirportSurveyFeedback(AirportSurveyFeedback airportSurvey)
        {
            ...
            if (validationStatus == true)
            {
                ...
                if (isValid == false)
                {
                    ...
                    {
                        TenderDBDataContext rdb = new TenderDBDataContext();
                        IXE_AirportSurveyFeedback ASF = new IXE_AirportSurveyFeedback();
                        ASF.Id = (rdb.IXE_AirportSurveyFeedbacks.Select(x => (long?)x.Id).Max() ?? 0) + 1;
                        ...
                        #region Insert to DB
                        rdb.IXE_AirportSurveyFeedbacks.InsertOnSubmit(ASF);
                        rdb.SubmitChanges();
        ...
        //Contact Us Form
        [HttpPost]
        public ActionResult AirportContactUs(IXEAirportContactUs airportContactUs)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    string securitytoken = DictionaryPhraseRepository.Current.Get("/IXEContactFormCRM/securitytoken", "");
                    string CRMAPI = DictionaryPhraseRepository.Current.Get("/IXEContactFormCRM/API", "");
                    Log.Info("CRM Start  IXE Contact Us form", this);
                    ...
                    Log.Info("CRM END  IXE Contact Us form", this);


                    Log.Info("Insert data into IXE Contact Us DB ", this);

                    TenderDBDataContext rdb = new TenderDBDataContext();
                    IXE_AirportContactUsForm contactUsForm = new IXE_AirportContactUsForm();
                    contactUsForm.Id = (rdb.IXE_AirportContactUsForms.Select(i => (long?)i.Id).Max() ?? 0) + 1;
                    ...
                    #region Insert to DB
                    rdb.IXE_AirportContactUsForms.InsertOnSubmit(contactUsForm);
                    rdb.SubmitChanges();
                    Log.Info("data inserted in  DB  sucessfully  IXE Contact Us form", this);
