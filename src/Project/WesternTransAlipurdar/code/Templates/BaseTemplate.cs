...
namespace Sitecore.WesternTransAlipurdar.Website.Templates
{
    public class BaseTemplate
    {
        ...
        {
            public class FormDataSources
            {
                public static readonly ID Thankyoupop = new ID("{72E252F4-7944-467F-B46C-826BA0F69DBF}");
                public static readonly ID ErrorMsgContextItem = new ID("{67DFD7D9-70D5-463F-91D1-D15289B9CEEB}");
            }
            ...
            {
                public static readonly ID requiredFieldErrorMessageName = new ID("{1431E5F8-A632-4BFA-9813-E04C62650EBA}");
                public static readonly ID maxLengthErrorMessageName = new ID("{6317B294-405F-4F38-B1D4-D402D70950BC}");
                public static readonly ID minLengthErrorMessageName = new ID("{3A8DE3C3-A020-4D6E-95B9-0C7B56416373}");
                public static readonly ID regexErrorMessageName = new ID("{73498B08-9482-4115-BD50-532E3BF09578}");

                public static readonly ID requiredFieldErrorMessageEmail = new ID("{19D65EC9-764A-4218-8C2C-003F132F8CDC}");
                public static readonly ID maxLengthErrorMessageEmail = new ID("{CAC96FCA-874C-43B4-A6A9-D1D5FC5F3D9A}");
                public static readonly ID minLengthErrorMessageEmail = new ID("{AF610BEE-A883-4C67-887F-D75E3B8EBE28}");
                public static readonly ID regexErrorMessageEmail = new ID("{449B6997-CE8C-4F8D-90D0-258FC91F9879}");

                public static readonly ID requiredFieldErrorMessageInquiry = new ID("{AB794B7F-BA84-4EE2-A4F2-EB49DF72C74C}");

                public static readonly ID requiredFieldErrorMessageMessage = new ID("{BF7C22C0-2B54-44A8-A65E-0B0EBDD47665}");
                public static readonly ID maxLengthErrorMessageMessage = new ID("{9B24316C-A50D-4D93-B9B2-61DFF47F9ABB}");
                public static readonly ID minLengthErrorMessageMessage = new ID("{5D2BC720-3C7B-4ABE-9E44-180D9DE166D2}");
                public static readonly ID regexErrorMessageMessage = new ID("{5531BBE5-4701-454B-B1F2-51DFEFD8B83F}");

                public static readonly ID requiredFieldErrorMessagereCaptcha = new ID("{7FF37835-614A-47B7-B976-96AC0E8FD0E1}");
            }
