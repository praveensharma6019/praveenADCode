<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationForm.aspx.cs" Inherits="Sitecore.GyaanGalaxy.Website.sitecore.admin.GyaanGalaxy.RegistrationForm" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 mx-auto vertical-middle">
                <p class="txt-center">
                    <img src="/images/GyaanGalaxy/logo.png" alt="Gyaan Galaxy" disablewebedit="False">
                </p>
