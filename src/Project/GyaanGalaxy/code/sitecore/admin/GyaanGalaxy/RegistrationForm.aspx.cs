          ...
          try
            {
                ...
                {
                    IQueryable<GyannGalaxyRegistrationForm> transmissioncostcalculator =
                        from rc in rdb.GyannGalaxyRegistrationForms
                    ...
                    DataTable dataTable = this.ToDataTable<GyannGalaxyRegistrationForm>(transmissioncostcalculator.ToList<GyannGalaxyRegistrationForm>());
