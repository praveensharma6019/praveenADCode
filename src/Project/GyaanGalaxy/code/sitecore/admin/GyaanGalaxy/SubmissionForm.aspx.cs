...
namespace Sitecore.GyaanGalaxy.Website.sitecore.admin.GyaanGalaxy
{
    public partial class SubmissionForm : System.Web.UI.Page
    {
        ...
        {
            GyaanGalaxyDataContext rdb = new GyaanGalaxyDataContext();
          try
            {
                ...
                {
                    IQueryable<GyaanGalaxySubmissionForm> transmissioncostcalculator =
                        from rc in rdb.GyaanGalaxySubmissionForms
                    ...
                    DataTable dataTable = this.ToDataTable<GyaanGalaxySubmissionForm>(transmissioncostcalculator.ToList<GyaanGalaxySubmissionForm>());
                    this.DatatableToCSV(dataTable, base.Server.MapPath("~/sitecore/admin/GyaanGalaxy/SampleFile/Form-Records.csv"));
                }
                else
                {
        ...
        public DataTable ToDataTable<T>(List<T> items)
        {
            ...
            foreach (T item in items)
            {
                ...
                {
                    if ((properties[j].Name.ToLower() == "UploadedFileType" ? false : properties[j].Name.ToLower() != "uploadresearchlink"))
                    {
