<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubmitYourIdeas.aspx.cs" Inherits="Sitecore.ICAN.Website.sitecore.admin.ICAN.SubmitYourIdeas" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 mx-auto vertical-middle">
                <p class="txt-center">
                    <img src="/images/ICAN/logo.svg" alt="ICAN" disablewebedit="False">
                </p>
