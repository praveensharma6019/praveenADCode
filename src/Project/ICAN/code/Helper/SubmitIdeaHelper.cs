...
using static Sitecore.ICAN.Website.Models.IcanSubmitYourIdeaModel;

namespace Sitecore.ICAN.Website.Helper
{
    public class SubmitIdeaHelper
    {
        private Database db = Factory.GetDatabase("web");

        public SubmitIdeaHelper()
        {
