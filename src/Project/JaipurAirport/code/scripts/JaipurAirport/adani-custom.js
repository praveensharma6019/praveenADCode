...
$(document).ready(function () {
    ...
    $('.innerv-carousel .owl-item .item').each(function () {
        ...
        if (typeof attr !== typeof undefined && attr !== false) {
            var videosrc = $(this).attr('data-videosrc');
            $(this).prepend('<video controls><source src="' + videosrc + '" type="video/mp4"></video>');
...
//    jQuery.ajax(
//        {
//            url: "/api/JaipurAirport/GetTenderDocument",
//            method: "GET",
//            data: {
//                Id: id
//            },
...
function loadWeather() {
    var url = "https://api.weatherapi.com/v1/current.json?key=e6f018f1071b4a2c9c392224212408&q=Jaipur&aqi=no";
    $.ajax({
        url: url,
...
$("#BtnAPASubmit").click(function () {
    ...
    */
    ...
    $.ajax({
        ...
        url: "/api/JaipurAirport/BookAirportAssistance",
        contentType: "application/json",
        success: function (data) {
            //////////////

            if (data.status == "1") {
                window.location.href = "https://stage.adaniuat.com/jaipur-airport/Assistance-thank-you";
...
$("#DateArrival").on("change", function () {
    ...
    $.ajax({
        ...
        url: "/api/JaipurAirport/JaipurFlightDetailsArrivalUpdate",
        contentType: "application/json",
        success: function (data) {
            $('#arrival2').html(data);
        }
...
$('span#submit').click(function () {
    ...
    if (confirm("Do you really want to delete this User")) {
        $.ajax({
            type: 'POST',
            data: { id: Id },
            url: "/api/JaipurAirport/DisableEnvelopeUser",
            success: function (data) {
                location.reload();
...
$('span#submits').click(function () {
    ...
    if (confirm("Do you really want to delete this User")) {
        $.ajax({
            type: 'POST',
            data: { id: Id },
            url: "/api/JaipurAirport/DisableAdminUser",
            success: function (data) {
                location.reload();
...
$("#DateDeparture").on("change", function () {
    ...
    $.ajax({
        ...
        url: "/api/JaipurAirport/JaipurFlightDetailsUpdateDeparture",
        contentType: "application/json",
        success: function (data) {
...
$("#DateArrivalInter").on("change", function () {
    ...
    $.ajax({
        ...
        url: "/api/TrivandrumAirport/JaipurFlightDetailsArrivalUpdate",
        contentType: "application/json",
        success: function (data) {
...
$("#DateDepart").on("change", function () {
    ...
    $.ajax({
        type: "Get",
        data: { DepartureFlight: DepartureFlights, FlightType: FlightType },
        url: "/api/TrivandrumAirport/JaipurFlightDetailsUpdateDeparture",
        contentType: "application/json",
        success: function (data) {
...
$("#btnSearch").click(function () {
    ...
    if ($("#txtSearch").val().length > 0 || $("#txtSearch").val() != "") {
        $.ajax({
            ...
            url: "/api/JaipurAirport/JaipurFlighSearchDetailsArival",
            contentType: "application/json",
            success: function (data) {
                if (data == "") {
...
$("#btnSearchDeparture").click(function () {
    ...
    if ($("#txtSearches").val().length > 0 || $("#txtSearches").val() != "") {
        $.ajax({
            ...
            url: "/api/JaipurAirport/JaipurFlighSearchDetailsDeparture",
            contentType: "application/json",
            success: function (data) {
                if (data == "") {
...
$("#BtnASFSubmit").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: JSON.stringify(model),
        url: "/api/JaipurAirport/AirportSurveyFeedback",
        contentType: "application/json",
        success: function (data) {
            //////////////
    ...
    grecaptcha.ready(function () {
        grecaptcha.execute('6LdoDj4hAAAAAD7gqiPJEsAy96GJBkiNRu9qohiz', { action: 'AirportContactUs' }).then(function (token) {
            ...
            $.ajax({
                ...
                url: "/api/JaipurAirport/AirportContactUs",
                contentType: "application/json",
                success: function (data) {
                    if (data.status == "1") {
                        window.location.href = "/jaipur-airport/thank-you";
                    }
