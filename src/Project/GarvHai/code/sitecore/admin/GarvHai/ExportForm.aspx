<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportForm.aspx.cs" Inherits="Sitecore.GarvHai.Website.sitecore.admin.GarvHai.WebForm1" %>
...
.txt-red{color:red;}
    ...
    <!-- Bootstrap core CSS -->
    <link href="../../../styles/GarvHai/bootstrap.min.css" rel="stylesheet" />
...
<body>
      <div class="container">
                <div class="row">
                                <div class="col-4 mx-auto vertical-middle">
                                                ...
                                                <p class="txt-center"><img src="../../../images/GarvHai/garvhai-logo.png" alt="GarvHai" disablewebedit="False" /></p>
        ...
        <div class="row">
                                     <div class="col-sm-6 mx-auto">
                                            ...
                                            <asp:DropDownList ID="ddl1" runat="server" class="col-sm-12 mx-auto p-1">
                                                ...
                                                <asp:ListItem>Apply Now Form</asp:ListItem>
                                                <asp:ListItem>Contact Us Form</asp:ListItem>
                                            </asp:DropDownList>
                                                                </div>
                                     </div>
                                    </div>
    ...
    <script src="../../../scripts/GarvHai/jquery.min.js"></script>
    <script src="../../../scripts/GarvHai/bootstrap.min.js"></script>
</body>
</html>