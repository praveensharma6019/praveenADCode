        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["Sorce"] != null && Request.QueryString["Sorce"] != string.Empty)
                {
                    ...
                    if (querystring == "InvestorDownloads")
                    { SourceDDL.Items.FindByText("Investor-Downloads : Income Statement as per SEBI format").Selected = true; }
                    if (querystring == "Corporate Governance")
                    { SourceDDL.Items.FindByText("Corporate-Governance : Policies").Selected = true; }
