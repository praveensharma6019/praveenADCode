...
{
    public class VectorCardContentResolver : RenderingContentsResolver
    {
        private readonly ISubNavService _subNav;

        public VectorCardContentResolver(ISubNavService subNavService)
        {
        ...
        {
            return _subNav.GetVectorCard(rendering);
        }
    }
}