...
{
    public class SelectingTechContentResolver : RenderingContentsResolver
    {
        private readonly ISubNavService _subNav;

        public SelectingTechContentResolver(ISubNavService subNavService)
        {
        ...
        {
            return _subNav.GetSelectingTech(rendering);
        }
    }
}