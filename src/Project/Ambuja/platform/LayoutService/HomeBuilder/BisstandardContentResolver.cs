...
{
    public class BisstandardContentResolver : RenderingContentsResolver
    {
        private readonly ISubNavService _subNav;

        public BisstandardContentResolver(ISubNavService subNavService)
        {
        ...
        {
            return _subNav.GetBisstandard(rendering);
        }
    }
}