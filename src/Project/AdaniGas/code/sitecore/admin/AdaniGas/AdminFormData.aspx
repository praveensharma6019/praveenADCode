<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFormData.aspx.cs" Inherits="Sitecore.AdaniGas.Website.sitecore.admin.AdaniGas.AdminFormData" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 mx-auto vertical-middle">
                <p class="txt-center">
                    <img src="/-/media/Project/AdaniGas/Logos/AdaniGaslogo.png?h=42&amp;la=en&amp;w=188&amp;hash=792BCB4E17A1624535B214D0F092E7A3" alt="Adani Gas" disablewebedit="False">
                </p>
