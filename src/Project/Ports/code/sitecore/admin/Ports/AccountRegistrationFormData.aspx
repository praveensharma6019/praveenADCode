<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountRegistrationFormData.aspx.cs" Inherits="Sitecore.Ports.Website.sitecore.admin.Ports.AccountRegistrationFormData" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 mx-auto vertical-middle">
                <p class="txt-center">
                    <img src="/images/ports/Ports-and-terminals-logo-footer.png" alt="Adani Ports" disablewebedit="False">
                </p>
