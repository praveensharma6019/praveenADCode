...
namespace Sitecore.Ports.Website.Providers
{
    public class Recaptchav2Provider : Controller
    {
        public bool IsReCaptchValid(string reResponse)
        {
            using (var client = new HttpClient())
            {
                ...
                //  var apiUrlCaptcha = "http://adani.dev.local/api/ValidateCaptcha/ValidateReCaptcha";
        ...
        public bool IsReCaptchValidV3(string reResponse)
        {
            ...
            {
                string SecretKey = DictionaryPhraseRepository.Current.Get("/CaptachaKey/SecretKey", "");
                //  var apiUrlCaptcha = "http://adani.dev.local/api/ValidateCaptcha/ValidateReCaptchaV3";
