...
{
    [Serializable]
    public class PortsGmsLevel2Dashbord
    {
        ...
        public List<PortsGmsLevel2Dashbord> AllBookings
        {
            get;
            set;
        }
        ...
        public PortsGmsLevel2Dashbord()
        {
            this.AllBookings = new List<PortsGmsLevel2Dashbord>();
