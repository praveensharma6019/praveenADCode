...
using Project.MiningRenderingHost.Website.Configurations;
using Project.MiningRenderingHost.Website.Extensions;
...
namespace Project.MiningRenderingHost.Website
{
    public class Startup
    {
        private static readonly string _defaultLanguage = "en";
        SitecoreConfigurations scObj = new SitecoreConfigurations();
        public Startup(IConfiguration configuration)
        {
            //Configuration = configuration.GetSection(SitecoreConfigurations.Key).Get<SitecoreConfigurations>();
            Configuration = scObj;
        }
        private SitecoreConfigurations Configuration { get; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSitecoreLayoutService()
                ...
                .AddHttpHandler("default", new System.Uri("https://sitecorecm.uat.adanirealty.com/sitecore/api/layout/render/jss"))
                .AsDefaultHandler();
            ...
            services.AddSitecoreRenderingEngine(options =>
            {
                ...
                //All components register in Extension Folder
                options
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                    "error",
                    "error",
                    new { controller = "Mining", action = "Error" }
                );

                // Enables the default Sitecore URL pattern with a language prefix.
                endpoints.MapSitecoreLocalizedRoute("sitecore", "Index", "Mining");

                // Fall back to language-less routing as well, and use the default culture (en).
                endpoints.MapFallbackToController("Index", "Mining");
