...
{
    public class FooterServiceModel : ImageModel
    {
        [SitecoreChildren]
        public virtual IEnumerable<NavigationList> MainNavigations { get; set; }
       
        public virtual string Copyright { get; set; }
    }
    public class NavigationList : GtmDataModel
    {
        
        public virtual string Heading { get; set; }
        [SitecoreChildren]
        public virtual IEnumerable<NavigationListItems> Items { get; set; }
