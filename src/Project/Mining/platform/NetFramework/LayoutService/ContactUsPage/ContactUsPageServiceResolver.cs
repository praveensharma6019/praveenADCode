...
{
    public class ContactUsPageServiceResolver : RenderingContentsResolver
    {
        private readonly IContactUsPageService _rootResolver;

        public ContactUsPageServiceResolver(IContactUsPageService rootResolver)
        {
        ...
        {
            return _rootResolver.GetContactUsPageDetails(rendering);
