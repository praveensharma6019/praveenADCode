    ...
    public static class GoogleRecaptcha
    {
        public static bool IsReCaptchValidV3(string reResponse)
        {
            try
            {
                ...
                {
                    Log.Info("Adani Wind | Captcha validation score status" + res.StatusCode, "");
                    return false;
                }
                ...
                {
                    Log.Info("Adani Wind | Captcha validation score"+score+"status"+ JSONdata.success,"");
                    return false;
                }
            ...
            {
                Log.Error("Adani Wind | Captcha validation Failed"+ex, "");
                return false;
            }
