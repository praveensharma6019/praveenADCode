...
namespace Sitecore.LucknowAirport.Website.Model
{
    public class LKOAirportContactUs
    {
        ...
        [Required(ErrorMessage = "Please enter Message"), MaxLength(1000)]
        [RegularExpression(@"^[A-Za-z0-9;,.?_\-!@&:""'\/\\ ]{0,1000}$", ErrorMessage = "Message is not valid, special characters not allowed")]
