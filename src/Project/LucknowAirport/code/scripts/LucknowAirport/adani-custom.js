...
//    jQuery.ajax(
//        {
//            url: "/api/LucknowAirport/GetTenderDocument",
//            method: "GET",
//            data: {
//                Id: id
//            },
...
var concat = '&';
var query = {'location': 'lucknow,in', 'format': 'json','u':'c'};
var oauth = {
 ...
 var TravelSector = $('input[name="TravelSector"]:checked').val();
   ...
   var tDate = Number($("#TravelMonth").val())+1 + "/" + $("#TravelDay").val() + "/" + $("#TravelYear").val();
    ...
    $.ajax({
        ...
        url: "/api/LucknowAirport/BookAirportAssistance",
        contentType: "application/json",
        success: function (data) {
            //////////////

            if (data.status == "1") {
                window.location.href = "https://stage.adaniuat.com/ccsia-lucknow-airport/Assistance-Thankyou";
...
$("#DateArrival").on("change", function () {
    ...
    $.ajax({
        ...
        url: "/api/LucknowAirport/LucknowFlightDetailsArrivalUpdate",
        contentType: "application/json",
        success: function (data) {
            $('#arrival2').html(data);
        }
...
$("#DateDeparture").on("change", function () {
    ...
    $.ajax({
        ...
        url: "/api/LucknowAirport/LucknowFlightDetailsUpdateDeparture",
        contentType: "application/json",
        success: function (data) {
...
$("#btnSearch").click(function () {
    ...
    if ($("#txtSearch").val().length > 0 || $("#txtSearch").val() != "") {
        $.ajax({
            ...
            url: "/api/LucknowAirport/LucknowFlighSearchDetailsArival",
            contentType: "application/json",
            success: function (data) {
                $('#arrival2').html(data);
            },
...
$("#btnSearchDeparture").click(function () {
    ...
    if ($("#txtSearches").val().length > 0 || $("#txtSearches").val() != "") {
        $.ajax({
            ...
            url: "/api/LucknowAirport/LucknowFlighSearchDetailsDeparture",
            contentType: "application/json",
            success: function (data) {
                $('#departure2').html(data);
            },
...
$("#BtnASFSubmit").click(function () {
    ...
    $.ajax({
        type: "POST",
        data: JSON.stringify(model),
        url: "/api/LucknowAirport/AirportSurveyFeedback",
        contentType: "application/json",
        success: function (data) {
            //////////////
        ...
        grecaptcha.ready(function() {
          grecaptcha.execute('6LdoDj4hAAAAAD7gqiPJEsAy96GJBkiNRu9qohiz', {action: 'AirportContactUs'}).then(function(token) {
			...
			$.ajax({
					...
					url: "/api/LucknowAirport/AirportContactUs",
					contentType: "application/json",
					success: function (data) {
						if (data.status == "1") {
							window.location.href = "/ccsia-lucknow-airport/thank-you";
						}
