...
namespace Sitecore.Enterprises.Website.sitecore.admin.Enterprises
{
    public partial class UploadDataForm : System.Web.UI.Page
    {
        ...
        private void UpdateSourceDDL()
        {
            ...
            Item items = master.GetItem("/sitecore/content/Enterprises/Global/Admin/MediaLibraryUpload");
