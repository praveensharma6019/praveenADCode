...
$(document).ready(function () {
    ...
    $('#btnEnquirySubmit').click(function () {
        ...
        var uname = $("#enquiry_form1 #uname").val();
        if (uname == "") { alert("Please enter your Firstname"); $("#enquiry_form1 #uname").focus(); $('#btnEnquirySubmit').removeAttr("disabled"); return false; }

        var uemail = $("#enquiry_form1 #uemail").val();
        if (uemail == "") { alert("Email is Required"); $("#enquiry_form1 #uemail").focus(); $('#btnEnquirySubmit').removeAttr("disabled"); return false; }
        var umobile = $("#enquiry_form1 #umobile").val();
        if (umobile == "") {
            alert("Please provide your Mobile Number");
            $("#enquiry_form1 #umobile").focus();
            $('#btnEnquirySubmit').removeAttr("disabled");
            return false;
        }
        else {
            if (document.enquiry_form1.country_code.value == 'IN' && document.enquiry_form1.umobile.value.length != 10) {
                alert("Mobile Number sould be 10 digit!");
                document.enquiry_form1.umobile.focus();
                $('#btnEnquirySubmit').removeAttr("disabled");
                return false;
            }
        }
        var ubudget = $("#enquiry_form1 #ubudget").val();
        if (ubudget == "") { alert("Please Enter your Budget"); $("#enquiry_form1 #ubudget").focus(); $('#btnEnquirySubmit').removeAttr("disabled"); return false; }
        var ucountry = $("#enquiry_form1 #ucountry").val();
        if (ucountry == "") { alert("Please select your country"); $("#enquiry_form1 #ucountry").focus(); $('#btnEnquirySubmit').removeAttr("disabled"); return false; }
        var ustate = $("#enquiry_form1 #ustate").val();
        if (ustate == "") { alert("Please select your state"); $("#enquiry_form1 #ustate").focus(); $('#btnEnquirySubmit').removeAttr("disabled"); return false; }
        var uremarks = $("#enquiry_form1 #uremarks").val();
        if (uremarks == "") { alert("Please enter your remarks"); $("#enquiry_form1 #uremarks").focus(); $('#btnEnquirySubmit').removeAttr("disabled"); return false; }
        // if (!captchavarified) {
        // alert("please click on captcha field");
        // $('#btnenquirysubmit').removeattr("disabled");
        // return false;
        // }
        var uinterest = $("#enquiry_form1 #uinterest").val();
        if (uinterest == "") { alert("Please select a property"); $("#enquiry_form1 #uinterest").focus(); $('#btnEnquirySubmit').removeAttr("disabled"); return false; }

        //create json object
        var countryname = $('#enquiry_form1 #ucountry :selected').text();
        var statename = $('#enquiry_form1 #ustate :selected').text();
    ...
    $("#enquiry_form1 #ucountry").change(function () {
        loadStateDrp('#enquiry_form1 #ustate');
    });
...
function loadStateDrp(statedrp) {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'AU') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'CA') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'BR') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'CN') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'DE') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'GB') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'IE') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'IN') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'IT') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'MX') {
    ...
    if ($("#enquiry_form1 #ucountry").val() == 'US') {
