...
$(document).ready(function () {
    ...
    $('#btnContactSubmit').click(function () {
        ...
        var cname = $("#contact_form1 #cname").val();
        if (cname == "") { alert("Please enter your Firstname"); $("#contact_form1 #cname").focus(); $('#btnContactSubmit').removeAttr("disabled"); return false; }

        var cemail = $("#contact_form1 #cemail").val();
        if (cemail == "") { alert("Email is Required"); $("#contact_form1 #cemail").focus(); $('#btnContactSubmit').removeAttr("disabled"); return false; }
        var cmobile = $("#contact_form1 #cmobile").val();
        if (cmobile == "") {
            alert("Please provide your Mobile Number");
            $("#contact_form1 #cmobile").focus();
            $('#btnContactSubmit').removeAttr("disabled");
            return false;
        }
        else {
            if (document.contact_form1.country_code.value == 'IN' && document.contact_form1.cmobile.value.length != 10) {
        ...
        var cbudget = $("#contact_form1 #cbudget").val();
        if (cbudget == "") { alert("Please Enter your Budget"); $("#contact_form1 #cbudget").focus(); $('#btnContactSubmit').removeAttr("disabled"); return false; }
        var ccountry = $("#contact_form1 #ccountry").val();
        if (ccountry == "") { alert("Please select your country"); $("#contact_form1 #ccountry").focus(); $('#btnContactSubmit').removeAttr("disabled"); return false; }
        var cstate = $("#contact_form1 #cstate").val();
        if (cstate == "") { alert("Please select your state"); $("#contact_form1 #cstate").focus(); $('#btnContactSubmit').removeAttr("disabled"); return false; }
        var cremarks = $("#contact_form1 #cremarks").val();
        if (cremarks == "") { alert("Please enter your remarks"); $("#contact_form1 #cremarks").focus(); $('#btnContactSubmit').removeAttr("disabled"); return false; }
        // if (!captchavarified) {
        // alert("please click on captcha field");
        // $('#btnContactSubmit').removeattr("disabled");
        // return false;
        // }
        var cinterest = $("#contact_form1 #cinterest").val();
        if (cinterest == "" || cinterest =="Projects Interested") { alert("Please select a property"); $("#contact_form1 #cinterest").focus(); $('#btnContactSubmit').removeAttr("disabled"); return false; }

        //create json object
        var countryname = $('#contact_form1 #ccountry :selected').text();
        var statename = $('#contact_form1 #cstate :selected').text();
        var currentdate = new Date().toISOString().slice(0, 19).replace('T', ' ');
        var cFormType = $('#contact_form1 #cFormType').val();
        var cpageinfo = ($('#contact_form1 #cPageInfo').val()).replace("/", "");

        if (cpageinfo == "" || cpageinfo == "/") { cpageinfo = "Home"; }
        ...
        $.ajax({
            ...
            url: "/api/Affordable/InsertEnquiryNowdetail",
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.status == "1") {
                                    ...
                                    var currentdate = new Date().toISOString().slice(0, 19).replace('T', ' ');
                                    var cFormType = $('#contact_form1 #cFormType').val();
                                    var pageinfo = ($('#contact_form1 #PageInfo').val()).replace("/", "");
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        data: JSON.stringify(savecustomdata),
                                        url: "/api/Realty/InsertEnquiryNowdetail",
                                        contentType: "application/json",
                                        success: function (data) {
                                            //////////////
    ...
    $("#contact_form1 #ccountry").change(function () {
        loadStateDrp('#contact_form1 #cstate');
    });
...
function loadStateDrp(statedrp) {
    ...
    if ($("#contact_form1 #ccountry").val() == 'AU') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'CA') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'BR') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'CN') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'DE') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'GB') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'IE') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'IN') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'IT') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'MX') {
    ...
    if ($("#contact_form1 #ccountry").val() == 'US') {
