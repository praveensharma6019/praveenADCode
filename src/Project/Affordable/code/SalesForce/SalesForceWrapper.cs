...
namespace Sitecore.Affordable.Website.SalesForce
{
    public class SalesForceWrapper
    {
        ...
        public SalesForceWrapper()
        {
            ...
            //Password = ConfigurationManager.AppSettings["Password"]; // + SecurityToken;
            //IsSandboxUser = ConfigurationManager.AppSettings["IsSandboxUser"];
            //SfdcSandboxEndPoint = ConfigurationManager.AppSettings["SfdcSandboxEndPoint"];
            //SfdcProductionEndPoint = ConfigurationManager.AppSettings["SfdcProductionEndPoint"];
            ...
            SecurityToken = itemInfo.Fields[Templates.SalesForce.Fields.SecurityToken].Value;
        ...
        public dynamic ExecuteQuery(string query)
        {
            try
            {
                ...
                var req = (HttpWebRequest)WebRequest.Create(EndPoint + "/services/data/v44.0/query/?q=" + query);
