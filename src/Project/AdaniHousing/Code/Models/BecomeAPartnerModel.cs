...
namespace Sitecore.AdaniHousing.Website.Models
{
    public class BecomeAPartnerModel
    {
        ...
        public static string InvalidEmailAddress
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniHousing/BecomeAPartner/Invalid Email Address", "Please enter a valid email address");
            }
        }
        public static string InvalidMobile
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniHousing/BecomeAPartner/Invalid Mobile", "Please enter a valid Mobile Number");
            }
        }
        public static string InvalidName
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniHousing/BecomeAPartner/Invalid Name", "Please enter a valid Name");
            }
        }
        ...
        public static string Required
        {
            get
            {
                return DictionaryPhraseRepository.Current.Get("/AdaniHousing/BecomeAPartner/Required", "Please enter value for {0}");
            }
        }
