$(document).ready(function () {
    // $('.cv.box').addClass('d-block'); //Change in new for emi calculator
    // $('.supply.box').addClass('d-none'); //Change in new for emi calculator
    // $('.business.box').addClass('d-none'); //Change in new for emi calculator
    // $('.farm.box').addClass('d-none'); //Change in new for emi calculator
$('#ApplyPoprecaptcha').hide();
...
$("#Carrerbtnsubmits").on("click", function () {
    var response = grecaptcha.getResponse(recaptcha1);
    if (response.length === 0) {
        alert("Captcha required.");
        return false;
    }
    $("#Career-reResponse").val(response);

});
$(window).on('load', function () {
	
	$("#default_modal").on('shown.bs.modal', function() { 
    $( '<p class="msf">Captcha Loading...</p>').insertAfter( "#ApplyPoprecaptcha" );
	setTimeout(function(){ $('#ApplyPoprecaptcha').show();$('.msf').hide() }, 1600);
   
});
$("#default_modal").on('hidden.bs.modal', function() { 
    ...
    if (currURL.toLowerCase() === "/our-loan-offerings/home-loans" || currURL.toLowerCase() === "/our%20loan%20offerings/home%20loans") {
        $('#PopLoan-Product').val('Housing');
    }
    if (currURL.toLowerCase() === "/our-loan-offerings/mortgage-loans" || currURL.toLowerCase() === "/our%20loan%20offerings/mortgage%20loans") {
        $('#PopLoan-Product').val('Housing');
    }
});
...
function homecalculateEMI() {
    ...
    var P = document.getElementById("homeloanamount").value;
    var r = document.getElementById("homeinterestrate").value;
    var n = document.getElementById("homemonths").value;
    ...
    //For Supply Chain Finance Start
    document.getElementById("hometenure").innerHTML = '' + n;
    document.getElementById("homeinterest").innerHTML = '' + r;
    document.getElementById("homeprincipal").innerHTML = '' + Math.round(P).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    //For Supply Chain Finance End
...
function mortgageEMICalculator() {
    // Formula: 
    // EMI = (P * R/12) * [ (1+R/12)^N] / [ (1+R/12)^N-1]  
    // isNaN(isNotaNumber): Check whether the value is Number or Not                
    ...
    var P = document.getElementById("mortloanamount").value;
    var r = document.getElementById("mortinterestrate").value;
    var n = document.getElementById("mortmonths").value;
    ...
    document.getElementById("lbtotintamt").innerHTML = '' + Math.round(totintamt).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    document.getElementById("lbtotintyear").innerHTML = '' + Math.round(totintyear).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    document.getElementById("morttenure").innerHTML = '' + n;
    document.getElementById("mortinterest").innerHTML = '' + r;
    document.getElementById("mortprincipal").innerHTML = '' + Math.round(P).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
...
$(document).change(function () {
    $('#loantype').change(function () {
        $('.home.box').removeClass('d-block');
    });
});
$(document).change(function () {
    $('#loantype').change(function () {
        $('.mort.box').removeClass('d-none');
    });
});
