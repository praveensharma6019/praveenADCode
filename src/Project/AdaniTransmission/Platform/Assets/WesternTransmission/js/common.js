...
$(document).ready(function() {
    ...
    $('ul.subNav > li').bind('mouseenter', function() {
        $('.navText').css('display', 'none');
    ...
    $('ul.thirdNav > li').bind('mouseenter', function() {
...
document.write("<div id='sentFeedbackSuccess' class='modal fade' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-header'> <button type='button' class='close' data-dismiss='modal'>&times;</button></div><div class='modal-body text-center'><h4 class='ad-secondary-color' id='messageSuccess'>Thank you for contacting us.</h4><p id='messageShort'>We have received your enquiry and shall get back to you shortly.</p></div><div class='modal-footer'> <button type='button' class='btn btn-default' data-dismiss='modal'>Close</button></div></div></div></div>")
