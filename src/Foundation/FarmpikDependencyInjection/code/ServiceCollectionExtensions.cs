...
namespace Sitecore.Foundation.Farmpik.DependencyInjection
{
    using System.IO;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddMvcWebAPIControllers(this IServiceCollection serviceCollection, params string[] assemblyFilters)
        {
            serviceCollection.AddMvcWebApiControllers(GetAssemblies(assemblyFilters));
        }

        public static void AddMvcWebApiControllers(this IServiceCollection serviceCollection, params Assembly[] assemblies)
        {
            serviceCollection.AddMvcWebApiControllers(assemblies, new[] { DefaultControllerFilter });
        }
        ...
        private static void AddMvcWebApiControllers(this IServiceCollection serviceCollection, IEnumerable<Assembly> assemblies, string[] classFilters)
        {
            var controllers = GetTypesImplementing(typeof(System.Web.Http.ApiController), assemblies, classFilters);
