namespace Sitecore.Foundation.SitecoreExtensions.Extensions
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static HtmlString ImageFieldWithoutSize(this SitecoreHelper helper, ID fieldID, Item item, int mh = 0, int mw = 0, string cssClass = null, bool disableWebEditing = false)
        {
            var data = helper.Field(fieldID.ToString(), item, new
            {
                mh,
                mw,
                DisableWebEdit = disableWebEditing,
            ...
            var imageTag = data.ToHtmlString();
        ...
        public static HtmlString ImageFieldWithoutSize2(this SitecoreHelper helper, ID fieldID, Item item, int mh = 0, int mw = 0, string cssClass = null, bool disableWebEditing = false)
        {
            var data = helper.Field(fieldID.ToString(), item, new
            {
                mh,
