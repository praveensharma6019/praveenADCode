...
{
    public class PromotionOfferBannerMobileImageComputedField : IComputedIndexField
    {
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            ImageField img = item.Fields[Templates.OfferCollection.OfferMobileBannerImageFieldID];
