...
{
    public class OfferIsActiveComputedField : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            Sitecore.Data.Fields.CheckboxField isActive = item.Fields[Templates.OfferCollection.OfferIsActive];
