...
{
    public class DutyfreeSubCategory : IComputedIndexField
    {
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            try
            {
                ...
                if (categoryFolder.HasChildren)
                {
                    ...
                    if (categoryItems.Any())
                    {
                        ...
                        {
                            subcategoryCode = subcategoryItem.Fields[Templates.DFCollection.Code].ToString().ToLower();
                        }
                    }
                }
            ...
            {
                Log.Warn(string.Format("{0} : unsupported Template type : {1} -- Error -- DutyfreeSubCategory -- {2}", this, indexable.GetType(), ex), this);
            }
