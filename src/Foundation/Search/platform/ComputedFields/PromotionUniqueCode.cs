...
{
    public class PromotionUniqueCode : AbstractComputedIndexField
    {
        public override object ComputeFieldValue(IIndexable indexable)
        {
            ...
            string PromotionUniqueID = !string.IsNullOrEmpty(item.Fields[Templates.OfferCollection.PromotionOfferUniqueFieldID].Value) ?
                                item.Fields[Templates.OfferCollection.PromotionOfferUniqueFieldID].Value :
                                string.Empty;
            return PromotionUniqueID.ToLower();
        }
    }
}