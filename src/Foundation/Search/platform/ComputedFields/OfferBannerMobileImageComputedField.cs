...
{
    public class OfferBannerMobileImageComputedField : IComputedIndexField
    {
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            ImageField img = item.Fields[Templates.OfferCollection.PromotionBannerImageMobileFieldID];
