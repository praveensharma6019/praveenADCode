...
{
    public class OfferBannerDesktopImageComputedField : IComputedIndexField
    {
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            ImageField img = item.Fields[Templates.OfferCollection.PromotionBannerImageDesktopFieldID];
