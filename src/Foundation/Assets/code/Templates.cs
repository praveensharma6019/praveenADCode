    ...
    public struct Templates
    {
        public struct RenderingAssets
        {
            ...
            public struct Fields
            {
                ...
                public static readonly ID HeadScriptFiles = new ID("{975CC1C8-F6B8-49AC-A561-EFB2C680ECA8}");
                public static readonly ID HeadInlineScript = new ID("{4108EEF0-3C77-4D07-B68A-7480E37ABDE7}");
