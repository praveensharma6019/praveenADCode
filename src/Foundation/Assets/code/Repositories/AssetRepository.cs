namespace Sitecore.Foundation.Assets.Repositories
{
    ...
    public class AssetRepository
    {
        ...
        public Asset AddHeadInlineScript(string script, ScriptLocation location, bool preventAddToCache)
        {
            return this.AddAsset(script, location, preventAddToCache, AssetType.Raw, AssetContentType.Inline);
        }
