...
namespace Adani.Foundation.Messaging.Services.SMS
{
    public class SMSService : ISMSService
    {
        ...
        public bool SendSMSFarmpik(string mobile, FarmpikSMSModel data)
        {
            try
            {
                Sitecore.Diagnostics.Log.Info("Inside try block of SMSService.SendSMSFarmpik", "SMSService.SendSMSFarmpik");
                var smsapiurl = "https://www.adanione.com/api/cleartripwrapper/api/trip/sendsms";
                ...
                Sitecore.Diagnostics.Log.Info("Reuest sent and receivedv SMS Service Response:" + response, "");
                return response.IsSuccessStatusCode;
            }
            catch (Exception ex)
            {
